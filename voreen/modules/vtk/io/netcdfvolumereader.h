...
#ifndef VRN_NETCDFVOLUMEREADER_H
#define VRN_NETCDFVOLUMEREADER_H
...
/**
 * This reader is capable of reading NetCDF files.
 */
class VRN_CORE_API NetCDFVolumeReader : public VolumeReader {
public:
    NetCDFVolumeReader(ProgressBar* progress = 0);

    virtual std::string getClassName() const { return "NetCDFVolumeReader"; }
    virtual std::string getFormatDescription() const { return "NetCDF format (CF convention)"; }
