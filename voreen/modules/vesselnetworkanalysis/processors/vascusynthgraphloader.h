...
protected:
    virtual void setDescriptions() {
        setDescription("This processor can be used to load ground truth graph data provided by <a href=\"http://vascusynth.cs.sfu.ca/Welcome.html\">VascuSynth</a> in an xml file.");
        graphFilePath_.setDescription("Path to the tree_structure.xml file generated by VascuSynth.");
    }
