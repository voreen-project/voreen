...
protected:
    virtual void setDescriptions() {
        setDescription("Will provide the basic filtering operators like median and gaussian filtering (work in progress).");
    }
...
private:
    ...
    /// adjusts the property visibility according to the selected filter and also sets the automatic sigma for the gaussian if necessary
