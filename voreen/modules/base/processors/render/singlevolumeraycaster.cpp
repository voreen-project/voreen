...
SingleVolumeRaycaster::SingleVolumeRaycaster()
    ...
    , transFunc1DProp1_("transferFunction", "Transfer Function 1D")
    ...
    , transFunc2DProp1_("transFunc2D", "Transfer Function 2D")
    ...
    , transFunc1DGaussianProp1_("transFuncGaussian1", "Transfer Function 1D Gaussian")
    , transFunc1DGaussianProp2_("transFuncGaussian2", "Transfer Function 1D Gaussian (Channel 2)")
    , transFunc1DGaussianProp3_("transFuncGaussian3", "Transfer Function 1D Gaussian (Channel 2)")
    , transFunc1DGaussianProp4_("transFuncGaussian4", "Transfer Function 1D Gaussian (Channel 2)")
