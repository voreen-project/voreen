...
class VRN_CORE_API VolumeFormatConversion : public CachingVolumeProcessor {
public:
...
protected:
    virtual void setDescriptions() {
        setDescription("Converts a single-channel input volume to an arbitrary single-channel target format.");
    }
