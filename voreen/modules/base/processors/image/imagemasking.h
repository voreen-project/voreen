 ...
 */
class VRN_CORE_API ImageMasking : public ImageProcessorBypassable {
public:
    ImageMasking();
...
protected:
    virtual void setDescriptions() {
        setDescription("Masks the input image: All fragments matching the mask color in the mask texture are cleared.");
    }
