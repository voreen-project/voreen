...
OptimizedProxyGeometry::OptimizedProxyGeometry()
    ...
    , tfChannel0_("transferfunction", "To be Linked Transfer Function (Channel 0)")
    ...
    , backgroundThread_(0)
    , tfChannel1_("transferfunction2", "To be Linked Transfer Function (Channel 1)")
    , tfChannel2_("transferfunction3", "To be Linked Transfer Function (Channel 2)")
    , tfChannel3_("transferfunction4", "To be Linked Transfer Function (Channel 3)")
    , currentVolume_(0)
{
