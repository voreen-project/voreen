 ...
 */
void main() {
    gl_Position = modelViewProjectionMatrixStack_ * (vert_position + vec4(translate_, 0.0));
    frag_EyePosition = (modelViewMatrixStack_ * (vert_position + vec4(translate_, 0.0))).xyz;
