...
#pragma omp parallel for
				...
				const_cast<VolumeBase*>( timesteps[timestep].getVolume( flowComponentNameX ) )->removeRepresentation<VolumeRAM>();
				const_cast<VolumeBase*>( timesteps[timestep].getVolume( flowComponentNameY ) )->removeRepresentation<VolumeRAM>();
				const_cast<VolumeBase*>( timesteps[timestep].getVolume( flowComponentNameZ ) )->removeRepresentation<VolumeRAM>();
			}
			else break;
		}
