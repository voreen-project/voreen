...
#ifndef VRN_STREAMLINELISTPORT_H
#define VRN_STREAMLINELISTPORT_H

#include "voreen/core/ports/genericport.h"

#include "../datastructures/streamlinelistbase.h"
...
namespace voreen {
     ...
     * @see streamline
     */
class StreamlineListPort : public GenericPort<StreamlineListBase> {
public:
    StreamlineListPort(PortDirection direction, const std::string& id, const std::string& guiName = "",
...
#endif //VRN_STREAMLINELISTPORT_H
