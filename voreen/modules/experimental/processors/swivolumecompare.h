...
#ifndef VRN_SWIVOLUMECOMPARE_H
#define VRN_SWIVOLUMECOMPARE_H
...
class SWIVolumeCompare : public CachingVolumeProcessor {
...
public:
    ...
    virtual std::string getClassName() const      { return "SWIVolumeCompare";     }
