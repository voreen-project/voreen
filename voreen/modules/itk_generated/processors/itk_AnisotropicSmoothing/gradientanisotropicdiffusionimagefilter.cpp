...
const std::string GradientAnisotropicDiffusionImageFilterITK::loggerCat_("voreen.GradientAnisotropicDiffusionImageFilterITK");

GradientAnisotropicDiffusionImageFilterITK::GradientAnisotropicDiffusionImageFilterITK()
    : ITKProcessor(),
...
Processor* GradientAnisotropicDiffusionImageFilterITK::create() const {
    return new GradientAnisotropicDiffusionImageFilterITK();
}
...
void GradientAnisotropicDiffusionImageFilterITK::process() {
    ...
    if (dynamic_cast<const VolumeRAM_Float*>(inputVolume1))  {
        gradientAnisotropicDiffusionImageFilterITK<float>();
    }
    else if (dynamic_cast<const VolumeRAM_Double*>(inputVolume1))  {
        gradientAnisotropicDiffusionImageFilterITK<double>();
    }
    else {
