...
#include "vectorgradientanisotropicdiffusionimagefilter.h"
...
const std::string VectorGradientAnisotropicDiffusionImageFilterITK::loggerCat_("voreen.VectorGradientAnisotropicDiffusionImageFilterITK");

VectorGradientAnisotropicDiffusionImageFilterITK::VectorGradientAnisotropicDiffusionImageFilterITK()
    : ITKProcessor(),
...
Processor* VectorGradientAnisotropicDiffusionImageFilterITK::create() const {
    return new VectorGradientAnisotropicDiffusionImageFilterITK();
}

template<class T>
void VectorGradientAnisotropicDiffusionImageFilterITK::vectorGradientAnisotropicDiffusionImageFilterVec2ITK() {
    ...
    //Filter define
    typedef itk::VectorGradientAnisotropicDiffusionImageFilter<InputImageType1, OutputImageType1> FilterType;
...
template<class T>
void VectorGradientAnisotropicDiffusionImageFilterITK::vectorGradientAnisotropicDiffusionImageFilterVec3ITK() {
...
template<class T>
void VectorGradientAnisotropicDiffusionImageFilterITK::vectorGradientAnisotropicDiffusionImageFilterVec4ITK() {
...
void VectorGradientAnisotropicDiffusionImageFilterITK::process() {
    ...
    if (dynamic_cast<const VolumeRAM_4xFloat*>(inputVolume1))  {
        vectorGradientAnisotropicDiffusionImageFilterVec4ITK<float>();
    }
    else if (dynamic_cast<const VolumeRAM_4xDouble*>(inputVolume1))  {
        vectorGradientAnisotropicDiffusionImageFilterVec4ITK<double>();
    }
    else if (dynamic_cast<const VolumeRAM_3xFloat*>(inputVolume1))  {
        vectorGradientAnisotropicDiffusionImageFilterVec3ITK<float>();
    }
    else if (dynamic_cast<const VolumeRAM_3xDouble*>(inputVolume1))  {
        vectorGradientAnisotropicDiffusionImageFilterVec3ITK<double>();
    }
    else if (dynamic_cast<const VolumeRAM_2xFloat*>(inputVolume1))  {
        vectorGradientAnisotropicDiffusionImageFilterVec2ITK<float>();
    }
    else if (dynamic_cast<const VolumeRAM_2xDouble*>(inputVolume1))  {
        vectorGradientAnisotropicDiffusionImageFilterVec2ITK<double>();
    }
    else {
