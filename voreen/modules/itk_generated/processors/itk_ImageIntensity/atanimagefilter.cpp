...
const std::string AtanImageFilterITK::loggerCat_("voreen.AtanImageFilterITK");

AtanImageFilterITK::AtanImageFilterITK()
    : ITKProcessor(),
...
Processor* AtanImageFilterITK::create() const {
    return new AtanImageFilterITK();
}

template<class T>
void AtanImageFilterITK::atanImageFilterITK() {
    ...
    //Filter define
    typedef itk::AtanImageFilter<InputImageType1, OutputImageType1> FilterType;
...
void AtanImageFilterITK::process() {
