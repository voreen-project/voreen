...
#include "constrainedvalueadditionimagefilter.h"
...
const std::string ConstrainedValueAdditionImageFilterITK::loggerCat_("voreen.ConstrainedValueAdditionImageFilterITK");

ConstrainedValueAdditionImageFilterITK::ConstrainedValueAdditionImageFilterITK()
    : ITKProcessor(),
...
Processor* ConstrainedValueAdditionImageFilterITK::create() const {
    return new ConstrainedValueAdditionImageFilterITK();
}

template<class T, class S>
void ConstrainedValueAdditionImageFilterITK::constrainedValueAdditionImageFilterITK() {
    ...
    //Filter define
    typedef itk::ConstrainedValueAdditionImageFilter<InputImageType1, InputImageType2, OutputImageType1> FilterType;
...
void ConstrainedValueAdditionImageFilterITK::process() {
...
template <class T>
void ConstrainedValueAdditionImageFilterITK::volumeTypeSwitch1() {
