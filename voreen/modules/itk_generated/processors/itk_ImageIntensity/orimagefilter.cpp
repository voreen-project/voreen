...
const std::string OrImageFilterITK::loggerCat_("voreen.OrImageFilterITK");

OrImageFilterITK::OrImageFilterITK()
    : ITKProcessor(),
...
Processor* OrImageFilterITK::create() const {
    return new OrImageFilterITK();
}

template<class T, class S>
void OrImageFilterITK::orImageFilterITK() {
    ...
    //Filter define
    typedef itk::OrImageFilter<InputImageType1, InputImageType2, OutputImageType1> FilterType;
...
template <class T>
void OrImageFilterITK::volumeTypeSwitch1() {
