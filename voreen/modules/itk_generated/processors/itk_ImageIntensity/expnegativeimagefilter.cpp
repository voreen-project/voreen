...
#include "expnegativeimagefilter.h"
...
const std::string ExpNegativeImageFilterITK::loggerCat_("voreen.ExpNegativeImageFilterITK");

ExpNegativeImageFilterITK::ExpNegativeImageFilterITK()
    : ITKProcessor(),
...
Processor* ExpNegativeImageFilterITK::create() const {
    return new ExpNegativeImageFilterITK();
}

template<class T>
void ExpNegativeImageFilterITK::expNegativeImageFilterITK() {
    ...
    //Filter define
    typedef itk::ExpNegativeImageFilter<InputImageType1, OutputImageType1> FilterType;
...
void ExpNegativeImageFilterITK::process() {
