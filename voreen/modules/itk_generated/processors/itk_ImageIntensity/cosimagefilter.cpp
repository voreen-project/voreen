...
const std::string CosImageFilterITK::loggerCat_("voreen.CosImageFilterITK");

CosImageFilterITK::CosImageFilterITK()
    : ITKProcessor(),
...
Processor* CosImageFilterITK::create() const {
    return new CosImageFilterITK();
}

template<class T>
void CosImageFilterITK::cosImageFilterITK() {
    ...
    //Filter define
    typedef itk::CosImageFilter<InputImageType1, OutputImageType1> FilterType;
...
void CosImageFilterITK::process() {
