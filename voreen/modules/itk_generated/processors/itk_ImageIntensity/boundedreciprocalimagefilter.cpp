...
#include "boundedreciprocalimagefilter.h"
...
const std::string BoundedReciprocalImageFilterITK::loggerCat_("voreen.BoundedReciprocalImageFilterITK");

BoundedReciprocalImageFilterITK::BoundedReciprocalImageFilterITK()
    : ITKProcessor(),
...
Processor* BoundedReciprocalImageFilterITK::create() const {
    return new BoundedReciprocalImageFilterITK();
}

template<class T>
void BoundedReciprocalImageFilterITK::boundedReciprocalImageFilterITK() {
    ...
    //Filter define
    typedef itk::BoundedReciprocalImageFilter<InputImageType1, OutputImageType1> FilterType;
...
void BoundedReciprocalImageFilterITK::process() {
