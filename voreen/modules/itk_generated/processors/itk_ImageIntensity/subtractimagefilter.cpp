...
const std::string SubtractImageFilterITK::loggerCat_("voreen.SubtractImageFilterITK");

SubtractImageFilterITK::SubtractImageFilterITK()
    : ITKProcessor(),
...
Processor* SubtractImageFilterITK::create() const {
    return new SubtractImageFilterITK();
}

template<class T, class S>
void SubtractImageFilterITK::subtractImageFilterITK() {
    ...
    //Filter define
    typedef itk::SubtractImageFilter<InputImageType1, InputImageType2, OutputImageType1> FilterType;
...
void SubtractImageFilterITK::process() {
...
template <class T>
void SubtractImageFilterITK::volumeTypeSwitch1() {
