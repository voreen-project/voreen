...
const std::string MultiplyImageFilterITK::loggerCat_("voreen.MultiplyImageFilterITK");

MultiplyImageFilterITK::MultiplyImageFilterITK()
    : ITKProcessor(),
...
Processor* MultiplyImageFilterITK::create() const {
    return new MultiplyImageFilterITK();
}

template<class T, class S>
void MultiplyImageFilterITK::multiplyImageFilterITK() {
    ...
    //Filter define
    typedef itk::MultiplyImageFilter<InputImageType1, InputImageType2, OutputImageType1> FilterType;
...
void MultiplyImageFilterITK::process() {
...
template <class T>
void MultiplyImageFilterITK::volumeTypeSwitch1() {
