...
#include "weightedaddimagefilter.h"
...
const std::string WeightedAddImageFilterITK::loggerCat_("voreen.WeightedAddImageFilterITK");

WeightedAddImageFilterITK::WeightedAddImageFilterITK()
    : ITKProcessor(),
    inport1_(Port::INPORT, "InputImage1"),
    inport2_(Port::INPORT, "InputImage2"),
    outport1_(Port::OUTPORT, "OutputImage"),
    alpha_("alpha", "Alpha", 1.0f, 0.0f, 100.0f)
{
    addPort(inport1_);
...
Processor* WeightedAddImageFilterITK::create() const {
    return new WeightedAddImageFilterITK();
}

template<class T, class S>
void WeightedAddImageFilterITK::weightedAddImageFilterITK() {
    ...
    //Filter define
    typedef itk::WeightedAddImageFilter<InputImageType1, InputImageType2, OutputImageType1> FilterType;
...
void WeightedAddImageFilterITK::process() {
...
template <class T>
void WeightedAddImageFilterITK::volumeTypeSwitch1() {
