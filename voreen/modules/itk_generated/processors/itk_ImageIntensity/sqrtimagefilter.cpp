...
const std::string SqrtImageFilterITK::loggerCat_("voreen.SqrtImageFilterITK");

SqrtImageFilterITK::SqrtImageFilterITK()
    : ITKProcessor(),
...
Processor* SqrtImageFilterITK::create() const {
    return new SqrtImageFilterITK();
}

template<class T>
void SqrtImageFilterITK::sqrtImageFilterITK() {
    ...
    //Filter define
    typedef itk::SqrtImageFilter<InputImageType1, OutputImageType1> FilterType;
...
void SqrtImageFilterITK::process() {
