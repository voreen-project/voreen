...
const std::string TanImageFilterITK::loggerCat_("voreen.TanImageFilterITK");

TanImageFilterITK::TanImageFilterITK()
    : ITKProcessor(),
...
Processor* TanImageFilterITK::create() const {
    return new TanImageFilterITK();
}

template<class T>
void TanImageFilterITK::tanImageFilterITK() {
    ...
    //Filter define
    typedef itk::TanImageFilter<InputImageType1, OutputImageType1> FilterType;
...
void TanImageFilterITK::process() {
