...
#include "ternarymagnitudesquaredimagefilter.h"
...
const std::string TernaryMagnitudeSquaredImageFilterITK::loggerCat_("voreen.TernaryMagnitudeSquaredImageFilterITK");

TernaryMagnitudeSquaredImageFilterITK::TernaryMagnitudeSquaredImageFilterITK()
    : ITKProcessor(),
...
Processor* TernaryMagnitudeSquaredImageFilterITK::create() const {
    return new TernaryMagnitudeSquaredImageFilterITK();
}

template<class T, class S, class R>
void TernaryMagnitudeSquaredImageFilterITK::ternaryMagnitudeSquaredImageFilterITK() {
    ...
    //Filter define
    typedef itk::TernaryMagnitudeSquaredImageFilter<InputImageType1, InputImageType2, InputImageType3, OutputImageType1> FilterType;
...
void TernaryMagnitudeSquaredImageFilterITK::process() {
...
template <class T>
void TernaryMagnitudeSquaredImageFilterITK::volumeTypeSwitch1() {
...
void TernaryMagnitudeSquaredImageFilterITK::volumeTypeSwitch2() {
    ...
    if (dynamic_cast<const VolumeRAM_UInt8*>(inputVolume3))  {
        ternaryMagnitudeSquaredImageFilterITK<T, S, uint8_t>();
    }
    else if (dynamic_cast<const VolumeRAM_Int8*>(inputVolume3))  {
        ternaryMagnitudeSquaredImageFilterITK<T, S, int8_t>();
    }
    else if (dynamic_cast<const VolumeRAM_UInt16*>(inputVolume3))  {
        ternaryMagnitudeSquaredImageFilterITK<T, S, uint16_t>();
    }
    else if (dynamic_cast<const VolumeRAM_Int16*>(inputVolume3))  {
        ternaryMagnitudeSquaredImageFilterITK<T, S, int16_t>();
    }
    else if (dynamic_cast<const VolumeRAM_UInt32*>(inputVolume3))  {
        ternaryMagnitudeSquaredImageFilterITK<T, S, uint32_t>();
    }
    else if (dynamic_cast<const VolumeRAM_Int32*>(inputVolume3))  {
        ternaryMagnitudeSquaredImageFilterITK<T, S, int32_t>();
    }
    else if (dynamic_cast<const VolumeRAM_Float*>(inputVolume3))  {
        ternaryMagnitudeSquaredImageFilterITK<T, S, float>();
    }
    else if (dynamic_cast<const VolumeRAM_Double*>(inputVolume3))  {
        ternaryMagnitudeSquaredImageFilterITK<T, S, double>();
    }
    else {
