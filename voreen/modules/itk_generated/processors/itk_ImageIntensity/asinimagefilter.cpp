...
const std::string AsinImageFilterITK::loggerCat_("voreen.AsinImageFilterITK");

AsinImageFilterITK::AsinImageFilterITK()
    : ITKProcessor(),
...
Processor* AsinImageFilterITK::create() const {
    return new AsinImageFilterITK();
}

template<class T>
void AsinImageFilterITK::asinImageFilterITK() {
    ...
    //Filter define
    typedef itk::AsinImageFilter<InputImageType1, OutputImageType1> FilterType;
...
void AsinImageFilterITK::process() {
