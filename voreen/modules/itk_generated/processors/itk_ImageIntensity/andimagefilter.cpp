...
const std::string AndImageFilterITK::loggerCat_("voreen.AndImageFilterITK");

AndImageFilterITK::AndImageFilterITK()
    : ITKProcessor(),
...
Processor* AndImageFilterITK::create() const {
    return new AndImageFilterITK();
}

template<class T, class S>
void AndImageFilterITK::andImageFilterITK() {
    ...
    //Filter define
    typedef itk::AndImageFilter<InputImageType1, InputImageType2, OutputImageType1> FilterType;
...
void AndImageFilterITK::process() {
...
template <class T>
void AndImageFilterITK::volumeTypeSwitch1() {
