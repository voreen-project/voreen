...
const std::string InvertIntensityImageFilterITK::loggerCat_("voreen.InvertIntensityImageFilterITK");

InvertIntensityImageFilterITK::InvertIntensityImageFilterITK()
    : ITKProcessor(),
...
Processor* InvertIntensityImageFilterITK::create() const {
    return new InvertIntensityImageFilterITK();
}

template<class T>
void InvertIntensityImageFilterITK::invertIntensityImageFilterITK() {
    ...
    //Filter define
    typedef itk::InvertIntensityImageFilter<InputImageType1, OutputImageType1> FilterType;
    typename FilterType::Pointer filter = FilterType::New();

    filter->SetInput(p1);

    filter->SetMaximum(maximum_.getValue<T>());
...
void InvertIntensityImageFilterITK::process() {
