...
const std::string MinimumImageFilterITK::loggerCat_("voreen.MinimumImageFilterITK");

MinimumImageFilterITK::MinimumImageFilterITK()
    : ITKProcessor(),
...
Processor* MinimumImageFilterITK::create() const {
    return new MinimumImageFilterITK();
}

template<class T, class S>
void MinimumImageFilterITK::minimumImageFilterITK() {
    ...
    //Filter define
    typedef itk::MinimumImageFilter<InputImageType1, InputImageType2, OutputImageType1> FilterType;
...
void MinimumImageFilterITK::process() {
...
template <class T>
void MinimumImageFilterITK::volumeTypeSwitch1() {
