...
const std::string AcosImageFilterITK::loggerCat_("voreen.AcosImageFilterITK");

AcosImageFilterITK::AcosImageFilterITK()
    : ITKProcessor(),
...
Processor* AcosImageFilterITK::create() const {
    return new AcosImageFilterITK();
}

template<class T>
void AcosImageFilterITK::acosImageFilterITK() {
    ...
    //Filter define
    typedef itk::AcosImageFilter<InputImageType1, OutputImageType1> FilterType;
...
void AcosImageFilterITK::process() {
