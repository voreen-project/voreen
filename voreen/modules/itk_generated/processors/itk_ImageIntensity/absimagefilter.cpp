...
const std::string AbsImageFilterITK::loggerCat_("voreen.AbsImageFilterITK");

AbsImageFilterITK::AbsImageFilterITK()
    : ITKProcessor(),
...
Processor* AbsImageFilterITK::create() const {
    return new AbsImageFilterITK();
}

template<class T>
void AbsImageFilterITK::absImageFilterITK() {
    ...
    //Filter define
    typedef itk::AbsImageFilter<InputImageType1, OutputImageType1> FilterType;
...
void AbsImageFilterITK::process() {
