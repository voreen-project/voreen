...
const std::string MaximumImageFilterITK::loggerCat_("voreen.MaximumImageFilterITK");

MaximumImageFilterITK::MaximumImageFilterITK()
    : ITKProcessor(),
...
Processor* MaximumImageFilterITK::create() const {
    return new MaximumImageFilterITK();
}

template<class T, class S>
void MaximumImageFilterITK::maximumImageFilterITK() {
    ...
    //Filter define
    typedef itk::MaximumImageFilter<InputImageType1, InputImageType2, OutputImageType1> FilterType;
...
void MaximumImageFilterITK::process() {
...
template <class T>
void MaximumImageFilterITK::volumeTypeSwitch1() {
