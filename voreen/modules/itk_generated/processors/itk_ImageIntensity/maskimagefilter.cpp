...
const std::string MaskImageFilterITK::loggerCat_("voreen.MaskImageFilterITK");

MaskImageFilterITK::MaskImageFilterITK()
    : ITKProcessor(),
...
Processor* MaskImageFilterITK::create() const {
    return new MaskImageFilterITK();
}
...
void MaskImageFilterITK::process() {
...
template <class T>
void MaskImageFilterITK::volumeTypeSwitch1() {
