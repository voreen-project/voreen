...
#include "binarymagnitudeimagefilter.h"
...
const std::string BinaryMagnitudeImageFilterITK::loggerCat_("voreen.BinaryMagnitudeImageFilterITK");

BinaryMagnitudeImageFilterITK::BinaryMagnitudeImageFilterITK()
    : ITKProcessor(),
...
Processor* BinaryMagnitudeImageFilterITK::create() const {
    return new BinaryMagnitudeImageFilterITK();
}

template<class T, class S>
void BinaryMagnitudeImageFilterITK::binaryMagnitudeImageFilterITK() {
    ...
    //Filter define
    typedef itk::BinaryMagnitudeImageFilter<InputImageType1, InputImageType2, OutputImageType1> FilterType;
...
void BinaryMagnitudeImageFilterITK::process() {
...
template <class T>
void BinaryMagnitudeImageFilterITK::volumeTypeSwitch1() {
