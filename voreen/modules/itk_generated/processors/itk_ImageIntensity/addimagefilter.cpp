...
const std::string AddImageFilterITK::loggerCat_("voreen.AddImageFilterITK");

AddImageFilterITK::AddImageFilterITK()
    : ITKProcessor(),
...
Processor* AddImageFilterITK::create() const {
    return new AddImageFilterITK();
}

template<class T, class S>
void AddImageFilterITK::addImageFilterITK() {
    ...
    //Filter define
    typedef itk::AddImageFilter<InputImageType1, InputImageType2, OutputImageType1> FilterType;
...
void AddImageFilterITK::process() {
...
template <class T>
void AddImageFilterITK::volumeTypeSwitch1() {
