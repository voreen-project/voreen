...
const std::string NotImageFilterITK::loggerCat_("voreen.NotImageFilterITK");

NotImageFilterITK::NotImageFilterITK()
    : ITKProcessor(),
...
Processor* NotImageFilterITK::create() const {
    return new NotImageFilterITK();
}

template<class T>
void NotImageFilterITK::notImageFilterITK() {
    ...
    //Filter define
    typedef itk::NotImageFilter<InputImageType1, OutputImageType1> FilterType;
...
void NotImageFilterITK::process() {
