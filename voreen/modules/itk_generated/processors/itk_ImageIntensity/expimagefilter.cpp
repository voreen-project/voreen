...
const std::string ExpImageFilterITK::loggerCat_("voreen.ExpImageFilterITK");

ExpImageFilterITK::ExpImageFilterITK()
    : ITKProcessor(),
...
Processor* ExpImageFilterITK::create() const {
    return new ExpImageFilterITK();
}

template<class T>
void ExpImageFilterITK::expImageFilterITK() {
    ...
    //Filter define
    typedef itk::ExpImageFilter<InputImageType1, OutputImageType1> FilterType;
...
void ExpImageFilterITK::process() {
