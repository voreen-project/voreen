...
const std::string LogImageFilterITK::loggerCat_("voreen.LogImageFilterITK");

LogImageFilterITK::LogImageFilterITK()
    : ITKProcessor(),
...
Processor* LogImageFilterITK::create() const {
    return new LogImageFilterITK();
}

template<class T>
void LogImageFilterITK::logImageFilterITK() {
    ...
    //Filter define
    typedef itk::LogImageFilter<InputImageType1, OutputImageType1> FilterType;
...
void LogImageFilterITK::process() {
