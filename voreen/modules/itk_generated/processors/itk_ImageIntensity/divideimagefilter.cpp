...
const std::string DivideImageFilterITK::loggerCat_("voreen.DivideImageFilterITK");

DivideImageFilterITK::DivideImageFilterITK()
    : ITKProcessor(),
...
Processor* DivideImageFilterITK::create() const {
    return new DivideImageFilterITK();
}

template<class T, class S>
void DivideImageFilterITK::divideImageFilterITK() {
    ...
    //Filter define
    typedef itk::DivideImageFilter<InputImageType1, InputImageType2, OutputImageType1> FilterType;
...
void DivideImageFilterITK::process() {
...
template <class T>
void DivideImageFilterITK::volumeTypeSwitch1() {
