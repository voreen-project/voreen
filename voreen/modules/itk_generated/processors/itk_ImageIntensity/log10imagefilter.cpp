...
const std::string Log10ImageFilterITK::loggerCat_("voreen.Log10ImageFilterITK");

Log10ImageFilterITK::Log10ImageFilterITK()
    : ITKProcessor(),
...
Processor* Log10ImageFilterITK::create() const {
    return new Log10ImageFilterITK();
}

template<class T>
void Log10ImageFilterITK::log10ImageFilterITK() {
    ...
    //Filter define
    typedef itk::Log10ImageFilter<InputImageType1, OutputImageType1> FilterType;
...
void Log10ImageFilterITK::process() {
