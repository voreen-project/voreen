...
#include "gradientmagnitudeimagefilter.h"
...
const std::string GradientMagnitudeImageFilterITK::loggerCat_("voreen.GradientMagnitudeImageFilterITK");

GradientMagnitudeImageFilterITK::GradientMagnitudeImageFilterITK()
    : ITKProcessor(),
...
Processor* GradientMagnitudeImageFilterITK::create() const {
    return new GradientMagnitudeImageFilterITK();
}

template<class T>
void GradientMagnitudeImageFilterITK::gradientMagnitudeImageFilterITK() {
    ...
    //Filter define
    typedef itk::GradientMagnitudeImageFilter<InputImageType1, OutputImageType1> FilterType;
...
void GradientMagnitudeImageFilterITK::process() {
