...
#include "gradientmagnituderecursivegaussianimagefilter.h"
...
const std::string GradientMagnitudeRecursiveGaussianImageFilterITK::loggerCat_("voreen.GradientMagnitudeRecursiveGaussianImageFilterITK");

GradientMagnitudeRecursiveGaussianImageFilterITK::GradientMagnitudeRecursiveGaussianImageFilterITK()
    : ITKProcessor(),
    inport1_(Port::INPORT, "InputImage"),
    outport1_(Port::OUTPORT, "OutputImage"),
    enableProcessing_("enabled", "Enable", false),
    normalizeAcrossScale_("normalizeAcrossScale", "NormalizeAcrossScale", false),
    sigma_("sigma", "Sigma", 0.1f, 0.0f, 1.0f)
{
    addPort(inport1_);
    ...
    addProperty(normalizeAcrossScale_);
    addProperty(sigma_);

}

Processor* GradientMagnitudeRecursiveGaussianImageFilterITK::create() const {
    return new GradientMagnitudeRecursiveGaussianImageFilterITK();
}

template<class T>
void GradientMagnitudeRecursiveGaussianImageFilterITK::gradientMagnitudeRecursiveGaussianImageFilterITK() {
    ...
    //Filter define
    typedef itk::GradientMagnitudeRecursiveGaussianImageFilter<InputImageType1> FilterType;
...
void GradientMagnitudeRecursiveGaussianImageFilterITK::process() {
    ...
    if (dynamic_cast<const VolumeRAM_UInt8*>(inputVolume1))  {
        gradientMagnitudeRecursiveGaussianImageFilterITK<uint8_t>();
    }
    else if (dynamic_cast<const VolumeRAM_Int8*>(inputVolume1))  {
        gradientMagnitudeRecursiveGaussianImageFilterITK<int8_t>();
    }
    else if (dynamic_cast<const VolumeRAM_UInt16*>(inputVolume1))  {
        gradientMagnitudeRecursiveGaussianImageFilterITK<uint16_t>();
    }
    else if (dynamic_cast<const VolumeRAM_Int16*>(inputVolume1))  {
        gradientMagnitudeRecursiveGaussianImageFilterITK<int16_t>();
    }
    else if (dynamic_cast<const VolumeRAM_UInt32*>(inputVolume1))  {
        gradientMagnitudeRecursiveGaussianImageFilterITK<uint32_t>();
    }
    else if (dynamic_cast<const VolumeRAM_Int32*>(inputVolume1))  {
        gradientMagnitudeRecursiveGaussianImageFilterITK<int32_t>();
    }
    else if (dynamic_cast<const VolumeRAM_Float*>(inputVolume1))  {
        gradientMagnitudeRecursiveGaussianImageFilterITK<float>();
    }
    else if (dynamic_cast<const VolumeRAM_Double*>(inputVolume1))  {
        gradientMagnitudeRecursiveGaussianImageFilterITK<double>();
    }
    else {
