...
const std::string GradientImageFilterITK::loggerCat_("voreen.GradientImageFilterITK");

GradientImageFilterITK::GradientImageFilterITK()
    : ITKProcessor(),
...
Processor* GradientImageFilterITK::create() const {
    return new GradientImageFilterITK();
}

template<class T>
void GradientImageFilterITK::gradientImageFilterITK() {
    ...
    typedef itk::Image<itk::CovariantVector<float,3>, 3> OutputImageType1;

    typename InputImageType1::Pointer p1 = voreenToITK<T>(inport1_.getData());


    //Filter define
    typedef itk::GradientImageFilter<InputImageType1> FilterType;
    ...
    outputVolume1 = ITKVec3ToVoreenVec3Copy<float>(filter->GetOutput());
...
void GradientImageFilterITK::process() {
