...
#include "labeltorgbimagefilter.h"
...
const std::string LabelToRGBImageFilterITK::loggerCat_("voreen.LabelToRGBImageFilterITK");

LabelToRGBImageFilterITK::LabelToRGBImageFilterITK()
    : ITKProcessor(),
...
Processor* LabelToRGBImageFilterITK::create() const {
    return new LabelToRGBImageFilterITK();
}

template<class T>
void LabelToRGBImageFilterITK::labelToRGBImageFilterITK() {
    ...
    //Filter define
    typedef itk::LabelToRGBImageFilter<InputImageType1, OutputImageType1> FilterType;
...
void LabelToRGBImageFilterITK::process() {
