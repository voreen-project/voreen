...
#include "recursivegaussianimagefilter.h"
...
const std::string RecursiveGaussianImageFilterITK::loggerCat_("voreen.RecursiveGaussianImageFilterITK");

RecursiveGaussianImageFilterITK::RecursiveGaussianImageFilterITK()
    : ITKProcessor(),
...
Processor* RecursiveGaussianImageFilterITK::create() const {
    return new RecursiveGaussianImageFilterITK();
}

template<class T>
void RecursiveGaussianImageFilterITK::recursiveGaussianImageFilterITK() {
    ...
    //Filter define
    typedef itk::RecursiveGaussianImageFilter<InputImageType1, OutputImageType1> FilterType;
...
void RecursiveGaussianImageFilterITK::process() {
