...
#include "smoothingrecursivegaussianimagefilter.h"
...
const std::string SmoothingRecursiveGaussianImageFilterITK::loggerCat_("voreen.SmoothingRecursiveGaussianImageFilterITK");

SmoothingRecursiveGaussianImageFilterITK::SmoothingRecursiveGaussianImageFilterITK()
    : ITKProcessor(),
...
Processor* SmoothingRecursiveGaussianImageFilterITK::create() const {
    return new SmoothingRecursiveGaussianImageFilterITK();
}

template<class T>
void SmoothingRecursiveGaussianImageFilterITK::smoothingRecursiveGaussianImageFilterITK() {
    ...
    //Filter define
    typedef itk::SmoothingRecursiveGaussianImageFilter<InputImageType1, OutputImageType1> FilterType;
...
void SmoothingRecursiveGaussianImageFilterITK::process() {
