...
const std::string MedianImageFilterITK::loggerCat_("voreen.MedianImageFilterITK");

MedianImageFilterITK::MedianImageFilterITK()
    : ITKProcessor(),
    inport1_(Port::INPORT, "InputImage"),
    outport1_(Port::OUTPORT, "OutputImage"),
    enableProcessing_("enabled", "Enable", false),
    radius_("radius", "Radius", tgt::ivec3(1), tgt::ivec3(0), tgt::ivec3(3))
{
    addPort(inport1_);
...
Processor* MedianImageFilterITK::create() const {
    return new MedianImageFilterITK();
}

template<class T>
void MedianImageFilterITK::medianImageFilterITK() {
    ...
    //Filter define
    typedef itk::MedianImageFilter<InputImageType1, OutputImageType1> FilterType;
...
void MedianImageFilterITK::process() {
