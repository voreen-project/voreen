...
#include "binomialblurimagefilter.h"
...
const std::string BinomialBlurImageFilterITK::loggerCat_("voreen.BinomialBlurImageFilterITK");

BinomialBlurImageFilterITK::BinomialBlurImageFilterITK()
    : ITKProcessor(),
    inport1_(Port::INPORT, "InputImage"),
    outport1_(Port::OUTPORT, "OutputImage"),
    enableProcessing_("enabled", "Enable", false),
    repetitions_("repetitions", "Repetitions", 1, 1, 255)
{
    addPort(inport1_);
    ...
    addProperty(repetitions_);

}

Processor* BinomialBlurImageFilterITK::create() const {
    return new BinomialBlurImageFilterITK();
}

template<class T>
void BinomialBlurImageFilterITK::binomialBlurImageFilterITK() {
    ...
    //Filter define
    typedef itk::BinomialBlurImageFilter<InputImageType1, OutputImageType1> FilterType;
    typename FilterType::Pointer filter = FilterType::New();

    filter->SetInput(p1);

    filter->SetRepetitions(repetitions_.get());
...
void BinomialBlurImageFilterITK::process() {
