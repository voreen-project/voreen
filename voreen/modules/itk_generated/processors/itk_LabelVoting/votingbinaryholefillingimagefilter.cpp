...
#include "votingbinaryholefillingimagefilter.h"
...
const std::string VotingBinaryHoleFillingImageFilterITK::loggerCat_("voreen.VotingBinaryHoleFillingImageFilterITK");

VotingBinaryHoleFillingImageFilterITK::VotingBinaryHoleFillingImageFilterITK()
    : ITKProcessor(),
...
Processor* VotingBinaryHoleFillingImageFilterITK::create() const {
    return new VotingBinaryHoleFillingImageFilterITK();
}

template<class T>
void VotingBinaryHoleFillingImageFilterITK::votingBinaryHoleFillingImageFilterITK() {
    ...
    //Filter define
    typedef itk::VotingBinaryHoleFillingImageFilter<InputImageType1, OutputImageType1> FilterType;
...
void VotingBinaryHoleFillingImageFilterITK::process() {
