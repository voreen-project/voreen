...
#include "binarymedianimagefilter.h"
...
const std::string BinaryMedianImageFilterITK::loggerCat_("voreen.BinaryMedianImageFilterITK");

BinaryMedianImageFilterITK::BinaryMedianImageFilterITK()
    : ITKProcessor(),
...
Processor* BinaryMedianImageFilterITK::create() const {
    return new BinaryMedianImageFilterITK();
}

template<class T>
void BinaryMedianImageFilterITK::binaryMedianImageFilterITK() {
    ...
    //Filter define
    typedef itk::BinaryMedianImageFilter<InputImageType1, OutputImageType1> FilterType;
...
void BinaryMedianImageFilterITK::process() {
