...
#include "connectedcomponentimagefilter.h"
...
const std::string ConnectedComponentImageFilterITK::loggerCat_("voreen.ConnectedComponentImageFilterITK");

ConnectedComponentImageFilterITK::ConnectedComponentImageFilterITK()
    : ITKProcessor(),
    ...
    objectCount_("objectCount", "ObjectCount", 0, INT_MIN, INT_MAX)
{
    addPort(inport1_);
    ...
    addProperty(objectCount_);
    objectCount_.setReadOnlyFlag(true);

}

Processor* ConnectedComponentImageFilterITK::create() const {
    return new ConnectedComponentImageFilterITK();
}

template<class T>
void ConnectedComponentImageFilterITK::connectedComponentImageFilterITK() {
    ...
    //Filter define
    typedef itk::ConnectedComponentImageFilter<InputImageType1, OutputImageType1> FilterType;
    ...
    {
        filter->Update();
        objectCount_.set(filter->GetObjectCount());
...
void ConnectedComponentImageFilterITK::process() {
