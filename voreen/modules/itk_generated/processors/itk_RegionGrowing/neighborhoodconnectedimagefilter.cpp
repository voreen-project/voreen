...
#include "neighborhoodconnectedimagefilter.h"
...
const std::string NeighborhoodConnectedImageFilterITK::loggerCat_("voreen.NeighborhoodConnectedImageFilterITK");

NeighborhoodConnectedImageFilterITK::NeighborhoodConnectedImageFilterITK()
    : ITKProcessor(),
    ...
    upper_("upper", "Upper"),
    lower_("lower", "Lower"),
    radius_("radius", "Radius", tgt::ivec3(1), tgt::ivec3(0), tgt::ivec3(1000))
{
    addPort(inport1_);
...
Processor* NeighborhoodConnectedImageFilterITK::create() const {
    return new NeighborhoodConnectedImageFilterITK();
}

template<class T>
void NeighborhoodConnectedImageFilterITK::neighborhoodConnectedImageFilterITK() {
    ...
    //Filter define
    typedef itk::NeighborhoodConnectedImageFilter<InputImageType1, OutputImageType1> FilterType;
    ...
    typename InputImageType1::SizeType radius;
...
void NeighborhoodConnectedImageFilterITK::process() {
