...
const std::string OtsuThresholdImageFilterITK::loggerCat_("voreen.OtsuThresholdImageFilterITK");

OtsuThresholdImageFilterITK::OtsuThresholdImageFilterITK()
    : ITKProcessor(),
...
Processor* OtsuThresholdImageFilterITK::create() const {
    return new OtsuThresholdImageFilterITK();
}
...
void OtsuThresholdImageFilterITK::process() {
