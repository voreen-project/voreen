...
#ifndef VRN_BINARYTHRESHOLDIMAGEFILTER_H
#define VRN_BINARYTHRESHOLDIMAGEFILTER_H
...
public:
    ...
    virtual std::string getClassName() const  { return "BinaryThresholdImageFilterITK";  }
    virtual CodeState getCodeState() const    { return CODE_STATE_STABLE; }

protected:
    virtual void setDescriptions() {
        setDescription("<a href=\"http://www.itk.org/Doxygen/html/classitk_1_1BinaryThresholdImageFilter.html\">Go to ITK-Doxygen-Description</a>");
    }
    template<class T>
