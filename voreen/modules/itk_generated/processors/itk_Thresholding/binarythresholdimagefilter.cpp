...
const std::string BinaryThresholdImageFilterITK::loggerCat_("voreen.BinaryThresholdImageFilterITK");
...
Processor* BinaryThresholdImageFilterITK::create() const {
    return new BinaryThresholdImageFilterITK();
}
...
void BinaryThresholdImageFilterITK::process() {
    ...
    if (dynamic_cast<const VolumeRAM_UInt8*>(inputVolume1))  {
        ...
        binaryThresholdImageFilterITK<int8_t>();
    }
