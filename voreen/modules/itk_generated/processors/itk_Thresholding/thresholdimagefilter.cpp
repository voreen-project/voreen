...
const std::string ThresholdImageFilterITK::loggerCat_("voreen.ThresholdImageFilterITK");

ThresholdImageFilterITK::ThresholdImageFilterITK()
    : ITKProcessor(),
...
Processor* ThresholdImageFilterITK::create() const {
    return new ThresholdImageFilterITK();
}

template<class T>
void ThresholdImageFilterITK::thresholdImageFilterITK() {
    ...
    //Filter define
    typedef itk::ThresholdImageFilter<InputImageType1> FilterType;
...
void ThresholdImageFilterITK::process() {
