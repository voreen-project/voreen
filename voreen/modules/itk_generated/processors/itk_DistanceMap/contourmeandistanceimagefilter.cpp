...
#include "contourmeandistanceimagefilter.h"
...
const std::string ContourMeanDistanceImageFilterITK::loggerCat_("voreen.ContourMeanDistanceImageFilterITK");

ContourMeanDistanceImageFilterITK::ContourMeanDistanceImageFilterITK()
    : ITKProcessor(),
    inport1_(Port::INPORT, "InputImage1"),
    inport2_(Port::INPORT, "InputImage2"),
    meanDistance_("meanDistance", "MeanDistance", 0.f, -FLT_MAX, FLT_MAX)
{
    addPort(inport1_);
    ...
    addProperty(meanDistance_);
    meanDistance_.setReadOnlyFlag(true);

}

Processor* ContourMeanDistanceImageFilterITK::create() const {
    return new ContourMeanDistanceImageFilterITK();
}

template<class T, class S>
void ContourMeanDistanceImageFilterITK::contourMeanDistanceImageFilterITK() {
    ...
    //Filter define
    typedef itk::ContourMeanDistanceImageFilter<InputImageType1, InputImageType2> FilterType;
    ...
    {
        filter->Update();
        meanDistance_.set(filter->GetMeanDistance());
...
void ContourMeanDistanceImageFilterITK::process() {
...
template <class T>
void ContourMeanDistanceImageFilterITK::volumeTypeSwitch1() {
