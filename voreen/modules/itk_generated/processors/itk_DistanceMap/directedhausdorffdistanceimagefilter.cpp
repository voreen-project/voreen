...
#include "directedhausdorffdistanceimagefilter.h"
...
const std::string DirectedHausdorffDistanceImageFilterITK::loggerCat_("voreen.DirectedHausdorffDistanceImageFilterITK");

DirectedHausdorffDistanceImageFilterITK::DirectedHausdorffDistanceImageFilterITK()
    : ITKProcessor(),
    inport1_(Port::INPORT, "InputImage1"),
    inport2_(Port::INPORT, "InputImage2"),
    directedHausdorffDistance_("directedHausdorffDistance", "DirectedHausdorffDistance", 0.f, -FLT_MAX, FLT_MAX),
    averageHausdorffDistance_("averageHausdorffDistance", "AverageHausdorffDistance", 0.f, -FLT_MAX, FLT_MAX)
{
    addPort(inport1_);
    ...
    addProperty(directedHausdorffDistance_);
    directedHausdorffDistance_.setReadOnlyFlag(true);
    addProperty(averageHausdorffDistance_);
    averageHausdorffDistance_.setReadOnlyFlag(true);

}

Processor* DirectedHausdorffDistanceImageFilterITK::create() const {
    return new DirectedHausdorffDistanceImageFilterITK();
}

template<class T, class S>
void DirectedHausdorffDistanceImageFilterITK::directedHausdorffDistanceImageFilterITK() {
    ...
    //Filter define
    typedef itk::DirectedHausdorffDistanceImageFilter<InputImageType1, InputImageType2> FilterType;
    ...
    {
        filter->Update();
        directedHausdorffDistance_.set(filter->GetDirectedHausdorffDistance());
...
void DirectedHausdorffDistanceImageFilterITK::process() {
...
template <class T>
void DirectedHausdorffDistanceImageFilterITK::volumeTypeSwitch1() {
    ...
    if (dynamic_cast<const VolumeRAM_UInt8*>(inputVolume2))  {
        directedHausdorffDistanceImageFilterITK<T, uint8_t>();
    }
    else if (dynamic_cast<const VolumeRAM_Int8*>(inputVolume2))  {
        directedHausdorffDistanceImageFilterITK<T, int8_t>();
    }
    else if (dynamic_cast<const VolumeRAM_UInt16*>(inputVolume2))  {
        directedHausdorffDistanceImageFilterITK<T, uint16_t>();
    }
    else if (dynamic_cast<const VolumeRAM_Int16*>(inputVolume2))  {
        directedHausdorffDistanceImageFilterITK<T, int16_t>();
    }
    else if (dynamic_cast<const VolumeRAM_UInt32*>(inputVolume2))  {
        directedHausdorffDistanceImageFilterITK<T, uint32_t>();
    }
    else if (dynamic_cast<const VolumeRAM_Int32*>(inputVolume2))  {
        directedHausdorffDistanceImageFilterITK<T, int32_t>();
    }
    else if (dynamic_cast<const VolumeRAM_Float*>(inputVolume2))  {
        directedHausdorffDistanceImageFilterITK<T, float>();
    }
    else if (dynamic_cast<const VolumeRAM_Double*>(inputVolume2))  {
        directedHausdorffDistanceImageFilterITK<T, double>();
    }
    else {
