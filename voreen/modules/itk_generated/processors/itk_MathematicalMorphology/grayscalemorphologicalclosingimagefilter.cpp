...
#include "grayscalemorphologicalclosingimagefilter.h"
...
const std::string GrayscaleMorphologicalClosingImageFilterITK::loggerCat_("voreen.GrayscaleMorphologicalClosingImageFilterITK");

GrayscaleMorphologicalClosingImageFilterITK::GrayscaleMorphologicalClosingImageFilterITK()
    : ITKProcessor(),
    inport1_(Port::INPORT, "InputImage"),
    outport1_(Port::OUTPORT, "OutputImage"),
    enableProcessing_("enabled", "Enable", false),
    algorithm_("algorithm", "Algorithm", 0, 0, 1),
...
Processor* GrayscaleMorphologicalClosingImageFilterITK::create() const {
    return new GrayscaleMorphologicalClosingImageFilterITK();
}

template<class T>
void GrayscaleMorphologicalClosingImageFilterITK::grayscaleMorphologicalClosingImageFilterITK() {
    ...
    if(structuringElement_.get() == "binaryBall"){
        ...
        typedef itk::GrayscaleMorphologicalClosingImageFilter<InputImageType1, OutputImageType1, KernelType> FilterType;
...
void GrayscaleMorphologicalClosingImageFilterITK::process() {
    ...
    if (dynamic_cast<const VolumeRAM_UInt8*>(inputVolume1))  {
        grayscaleMorphologicalClosingImageFilterITK<uint8_t>();
    }
    else if (dynamic_cast<const VolumeRAM_Int8*>(inputVolume1))  {
        grayscaleMorphologicalClosingImageFilterITK<int8_t>();
    }
    else if (dynamic_cast<const VolumeRAM_UInt16*>(inputVolume1))  {
        grayscaleMorphologicalClosingImageFilterITK<uint16_t>();
    }
    else if (dynamic_cast<const VolumeRAM_Int16*>(inputVolume1))  {
        grayscaleMorphologicalClosingImageFilterITK<int16_t>();
    }
    else if (dynamic_cast<const VolumeRAM_UInt32*>(inputVolume1))  {
        grayscaleMorphologicalClosingImageFilterITK<uint32_t>();
    }
    else if (dynamic_cast<const VolumeRAM_Int32*>(inputVolume1))  {
        grayscaleMorphologicalClosingImageFilterITK<int32_t>();
    }
    else if (dynamic_cast<const VolumeRAM_Float*>(inputVolume1))  {
        grayscaleMorphologicalClosingImageFilterITK<float>();
    }
    else if (dynamic_cast<const VolumeRAM_Double*>(inputVolume1))  {
        grayscaleMorphologicalClosingImageFilterITK<double>();
    }
    else {
