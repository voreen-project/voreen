...
#include "basicdilateimagefilter.h"
...
const std::string BasicDilateImageFilterITK::loggerCat_("voreen.BasicDilateImageFilterITK");

BasicDilateImageFilterITK::BasicDilateImageFilterITK()
    : ITKProcessor(),
...
Processor* BasicDilateImageFilterITK::create() const {
    return new BasicDilateImageFilterITK();
}

template<class T>
void BasicDilateImageFilterITK::basicDilateImageFilterITK() {
    ...
    if(structuringElement_.get() == "binaryBall"){
        ...
        typedef itk::BasicDilateImageFilter<InputImageType1, OutputImageType1, KernelType> FilterType;
...
void BasicDilateImageFilterITK::process() {
