...
#include "grayscalemorphologicalopeningimagefilter.h"
...
const std::string GrayscaleMorphologicalOpeningImageFilterITK::loggerCat_("voreen.GrayscaleMorphologicalOpeningImageFilterITK");

GrayscaleMorphologicalOpeningImageFilterITK::GrayscaleMorphologicalOpeningImageFilterITK()
    : ITKProcessor(),
    inport1_(Port::INPORT, "InputImage"),
    outport1_(Port::OUTPORT, "OutputImage"),
    enableProcessing_("enabled", "Enable", false),
    algorithm_("algorithm", "Algorithm", 0, 0, 2),
...
Processor* GrayscaleMorphologicalOpeningImageFilterITK::create() const {
    return new GrayscaleMorphologicalOpeningImageFilterITK();
}

template<class T>
void GrayscaleMorphologicalOpeningImageFilterITK::grayscaleMorphologicalOpeningImageFilterITK() {
    ...
    if(structuringElement_.get() == "binaryBall"){
        ...
        typedef itk::GrayscaleMorphologicalOpeningImageFilter<InputImageType1, OutputImageType1, KernelType> FilterType;
...
void GrayscaleMorphologicalOpeningImageFilterITK::process() {
    ...
    if (dynamic_cast<const VolumeRAM_UInt8*>(inputVolume1))  {
        grayscaleMorphologicalOpeningImageFilterITK<uint8_t>();
    }
    else if (dynamic_cast<const VolumeRAM_Int8*>(inputVolume1))  {
        grayscaleMorphologicalOpeningImageFilterITK<int8_t>();
    }
    else if (dynamic_cast<const VolumeRAM_UInt16*>(inputVolume1))  {
        grayscaleMorphologicalOpeningImageFilterITK<uint16_t>();
    }
    else if (dynamic_cast<const VolumeRAM_Int16*>(inputVolume1))  {
        grayscaleMorphologicalOpeningImageFilterITK<int16_t>();
    }
    else if (dynamic_cast<const VolumeRAM_UInt32*>(inputVolume1))  {
        grayscaleMorphologicalOpeningImageFilterITK<uint32_t>();
    }
    else if (dynamic_cast<const VolumeRAM_Int32*>(inputVolume1))  {
        grayscaleMorphologicalOpeningImageFilterITK<int32_t>();
    }
    else if (dynamic_cast<const VolumeRAM_Float*>(inputVolume1))  {
        grayscaleMorphologicalOpeningImageFilterITK<float>();
    }
    else if (dynamic_cast<const VolumeRAM_Double*>(inputVolume1))  {
        grayscaleMorphologicalOpeningImageFilterITK<double>();
    }
    else {
