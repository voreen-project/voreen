...
#include "grayscalegrindpeakimagefilter.h"
...
const std::string GrayscaleGrindPeakImageFilterITK::loggerCat_("voreen.GrayscaleGrindPeakImageFilterITK");

GrayscaleGrindPeakImageFilterITK::GrayscaleGrindPeakImageFilterITK()
    : ITKProcessor(),
...
Processor* GrayscaleGrindPeakImageFilterITK::create() const {
    return new GrayscaleGrindPeakImageFilterITK();
}
...
void GrayscaleGrindPeakImageFilterITK::process() {
