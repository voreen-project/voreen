...
#include "reconstructionbyerosionimagefilter.h"
...
const std::string ReconstructionByErosionImageFilterITK::loggerCat_("voreen.ReconstructionByErosionImageFilterITK");

ReconstructionByErosionImageFilterITK::ReconstructionByErosionImageFilterITK()
    : ITKProcessor(),
...
Processor* ReconstructionByErosionImageFilterITK::create() const {
    return new ReconstructionByErosionImageFilterITK();
}

template<class T, class S>
void ReconstructionByErosionImageFilterITK::reconstructionByErosionImageFilterITK() {
    ...
    //Filter define
    typedef itk::ReconstructionByErosionImageFilter<InputImageType1, OutputImageType1> FilterType;
...
void ReconstructionByErosionImageFilterITK::process() {
...
template <class T>
void ReconstructionByErosionImageFilterITK::volumeTypeSwitch1() {
