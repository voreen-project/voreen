...
#include "movinghistogrammorphologicalgradientimagefilter.h"
...
const std::string MovingHistogramMorphologicalGradientImageFilterITK::loggerCat_("voreen.MovingHistogramMorphologicalGradientImageFilterITK");

MovingHistogramMorphologicalGradientImageFilterITK::MovingHistogramMorphologicalGradientImageFilterITK()
    : ITKProcessor(),
...
Processor* MovingHistogramMorphologicalGradientImageFilterITK::create() const {
    return new MovingHistogramMorphologicalGradientImageFilterITK();
}

template<class T>
void MovingHistogramMorphologicalGradientImageFilterITK::movingHistogramMorphologicalGradientImageFilterITK() {
    ...
    if(structuringElement_.get() == "binaryBall"){
        ...
        typedef itk::MovingHistogramMorphologicalGradientImageFilter<InputImageType1, OutputImageType1, KernelType> FilterType;
...
void MovingHistogramMorphologicalGradientImageFilterITK::process() {
    ...
    if (dynamic_cast<const VolumeRAM_UInt8*>(inputVolume1))  {
        movingHistogramMorphologicalGradientImageFilterITK<uint8_t>();
    }
    else if (dynamic_cast<const VolumeRAM_Int8*>(inputVolume1))  {
        movingHistogramMorphologicalGradientImageFilterITK<int8_t>();
    }
    else if (dynamic_cast<const VolumeRAM_UInt16*>(inputVolume1))  {
        movingHistogramMorphologicalGradientImageFilterITK<uint16_t>();
    }
    else if (dynamic_cast<const VolumeRAM_Int16*>(inputVolume1))  {
        movingHistogramMorphologicalGradientImageFilterITK<int16_t>();
    }
    else if (dynamic_cast<const VolumeRAM_UInt32*>(inputVolume1))  {
        movingHistogramMorphologicalGradientImageFilterITK<uint32_t>();
    }
    else if (dynamic_cast<const VolumeRAM_Int32*>(inputVolume1))  {
        movingHistogramMorphologicalGradientImageFilterITK<int32_t>();
    }
    else if (dynamic_cast<const VolumeRAM_Float*>(inputVolume1))  {
        movingHistogramMorphologicalGradientImageFilterITK<float>();
    }
    else if (dynamic_cast<const VolumeRAM_Double*>(inputVolume1))  {
        movingHistogramMorphologicalGradientImageFilterITK<double>();
    }
    else {
