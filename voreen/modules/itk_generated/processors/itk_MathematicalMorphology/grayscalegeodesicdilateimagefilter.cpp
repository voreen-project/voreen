...
#include "grayscalegeodesicdilateimagefilter.h"
...
const std::string GrayscaleGeodesicDilateImageFilterITK::loggerCat_("voreen.GrayscaleGeodesicDilateImageFilterITK");

GrayscaleGeodesicDilateImageFilterITK::GrayscaleGeodesicDilateImageFilterITK()
    : ITKProcessor(),
...
Processor* GrayscaleGeodesicDilateImageFilterITK::create() const {
    return new GrayscaleGeodesicDilateImageFilterITK();
}

template<class T, class S>
void GrayscaleGeodesicDilateImageFilterITK::grayscaleGeodesicDilateImageFilterITK() {
    ...
    //Filter define
    typedef itk::GrayscaleGeodesicDilateImageFilter<InputImageType1, OutputImageType1> FilterType;
...
void GrayscaleGeodesicDilateImageFilterITK::process() {
...
template <class T>
void GrayscaleGeodesicDilateImageFilterITK::volumeTypeSwitch1() {
