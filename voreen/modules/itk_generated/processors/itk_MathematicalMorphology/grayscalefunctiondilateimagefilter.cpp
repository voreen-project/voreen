...
#include "grayscalefunctiondilateimagefilter.h"
...
const std::string GrayscaleFunctionDilateImageFilterITK::loggerCat_("voreen.GrayscaleFunctionDilateImageFilterITK");

GrayscaleFunctionDilateImageFilterITK::GrayscaleFunctionDilateImageFilterITK()
    : ITKProcessor(),
...
Processor* GrayscaleFunctionDilateImageFilterITK::create() const {
    return new GrayscaleFunctionDilateImageFilterITK();
}

template<class T>
void GrayscaleFunctionDilateImageFilterITK::grayscaleFunctionDilateImageFilterITK() {
    ...
    if(structuringElement_.get() == "binaryBall"){
        ...
        typedef itk::GrayscaleFunctionDilateImageFilter<InputImageType1, OutputImageType1, KernelType> FilterType;
...
void GrayscaleFunctionDilateImageFilterITK::process() {
