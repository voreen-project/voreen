...
const std::string HConcaveImageFilterITK::loggerCat_("voreen.HConcaveImageFilterITK");

HConcaveImageFilterITK::HConcaveImageFilterITK()
    : ITKProcessor(),
...
Processor* HConcaveImageFilterITK::create() const {
    return new HConcaveImageFilterITK();
}

template<class T>
void HConcaveImageFilterITK::hConcaveImageFilterITK() {
    ...
    //Filter define
    typedef itk::HConcaveImageFilter<InputImageType1, OutputImageType1> FilterType;
...
void HConcaveImageFilterITK::process() {
