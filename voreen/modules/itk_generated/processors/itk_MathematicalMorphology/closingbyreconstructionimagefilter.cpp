...
#include "closingbyreconstructionimagefilter.h"
...
const std::string ClosingByReconstructionImageFilterITK::loggerCat_("voreen.ClosingByReconstructionImageFilterITK");

ClosingByReconstructionImageFilterITK::ClosingByReconstructionImageFilterITK()
    : ITKProcessor(),
...
Processor* ClosingByReconstructionImageFilterITK::create() const {
    return new ClosingByReconstructionImageFilterITK();
}

template<class T>
void ClosingByReconstructionImageFilterITK::closingByReconstructionImageFilterITK() {
    ...
    if(structuringElement_.get() == "binaryBall"){
        ...
        typedef itk::ClosingByReconstructionImageFilter<InputImageType1, OutputImageType1, KernelType> FilterType;
...
void ClosingByReconstructionImageFilterITK::process() {
