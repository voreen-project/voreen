...
#include "blacktophatimagefilter.h"
...
const std::string BlackTopHatImageFilterITK::loggerCat_("voreen.BlackTopHatImageFilterITK");

BlackTopHatImageFilterITK::BlackTopHatImageFilterITK()
    : ITKProcessor(),
...
Processor* BlackTopHatImageFilterITK::create() const {
    return new BlackTopHatImageFilterITK();
}

template<class T>
void BlackTopHatImageFilterITK::blackTopHatImageFilterITK() {
    ...
    if(structuringElement_.get() == "binaryBall"){
        ...
        typedef itk::BlackTopHatImageFilter<InputImageType1, OutputImageType1, KernelType> FilterType;
...
void BlackTopHatImageFilterITK::process() {
