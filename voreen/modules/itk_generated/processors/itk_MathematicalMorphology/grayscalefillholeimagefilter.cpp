...
#include "grayscalefillholeimagefilter.h"
...
const std::string GrayscaleFillholeImageFilterITK::loggerCat_("voreen.GrayscaleFillholeImageFilterITK");

GrayscaleFillholeImageFilterITK::GrayscaleFillholeImageFilterITK()
    : ITKProcessor(),
...
Processor* GrayscaleFillholeImageFilterITK::create() const {
    return new GrayscaleFillholeImageFilterITK();
}

template<class T>
void GrayscaleFillholeImageFilterITK::grayscaleFillholeImageFilterITK() {
    ...
    //Filter define
    typedef itk::GrayscaleFillholeImageFilter<InputImageType1, OutputImageType1> FilterType;
...
void GrayscaleFillholeImageFilterITK::process() {
