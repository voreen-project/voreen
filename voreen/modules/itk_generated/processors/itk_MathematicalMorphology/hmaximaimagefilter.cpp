...
const std::string HMaximaImageFilterITK::loggerCat_("voreen.HMaximaImageFilterITK");

HMaximaImageFilterITK::HMaximaImageFilterITK()
    : ITKProcessor(),
...
Processor* HMaximaImageFilterITK::create() const {
    return new HMaximaImageFilterITK();
}

template<class T>
void HMaximaImageFilterITK::hMaximaImageFilterITK() {
    ...
    //Filter define
    typedef itk::HMaximaImageFilter<InputImageType1, OutputImageType1> FilterType;
...
void HMaximaImageFilterITK::process() {
