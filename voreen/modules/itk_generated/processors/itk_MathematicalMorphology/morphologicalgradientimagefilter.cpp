...
#include "morphologicalgradientimagefilter.h"
...
const std::string MorphologicalGradientImageFilterITK::loggerCat_("voreen.MorphologicalGradientImageFilterITK");

MorphologicalGradientImageFilterITK::MorphologicalGradientImageFilterITK()
    : ITKProcessor(),
...
Processor* MorphologicalGradientImageFilterITK::create() const {
    return new MorphologicalGradientImageFilterITK();
}
...
void MorphologicalGradientImageFilterITK::process() {
