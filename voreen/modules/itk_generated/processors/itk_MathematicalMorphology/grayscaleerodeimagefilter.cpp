...
#include "grayscaleerodeimagefilter.h"
...
const std::string GrayscaleErodeImageFilterITK::loggerCat_("voreen.GrayscaleErodeImageFilterITK");

GrayscaleErodeImageFilterITK::GrayscaleErodeImageFilterITK()
    : ITKProcessor(),
...
Processor* GrayscaleErodeImageFilterITK::create() const {
    return new GrayscaleErodeImageFilterITK();
}
...
void GrayscaleErodeImageFilterITK::process() {
