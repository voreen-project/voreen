...
const std::string HConvexImageFilterITK::loggerCat_("voreen.HConvexImageFilterITK");

HConvexImageFilterITK::HConvexImageFilterITK()
    : ITKProcessor(),
...
Processor* HConvexImageFilterITK::create() const {
    return new HConvexImageFilterITK();
}

template<class T>
void HConvexImageFilterITK::hConvexImageFilterITK() {
    ...
    //Filter define
    typedef itk::HConvexImageFilter<InputImageType1, OutputImageType1> FilterType;
...
void HConvexImageFilterITK::process() {
