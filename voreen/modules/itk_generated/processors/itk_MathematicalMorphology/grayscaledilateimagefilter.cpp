...
#include "grayscaledilateimagefilter.h"
...
const std::string GrayscaleDilateImageFilterITK::loggerCat_("voreen.GrayscaleDilateImageFilterITK");

GrayscaleDilateImageFilterITK::GrayscaleDilateImageFilterITK()
    : ITKProcessor(),
...
Processor* GrayscaleDilateImageFilterITK::create() const {
    return new GrayscaleDilateImageFilterITK();
}

template<class T>
void GrayscaleDilateImageFilterITK::grayscaleDilateImageFilterITK() {
    ...
    if(structuringElement_.get() == "binaryBall"){
        ...
        typedef itk::GrayscaleDilateImageFilter<InputImageType1, OutputImageType1, KernelType> FilterType;
...
void GrayscaleDilateImageFilterITK::process() {
