...
#include "movinghistogramdilateimagefilter.h"
...
const std::string MovingHistogramDilateImageFilterITK::loggerCat_("voreen.MovingHistogramDilateImageFilterITK");

MovingHistogramDilateImageFilterITK::MovingHistogramDilateImageFilterITK()
    : ITKProcessor(),
...
Processor* MovingHistogramDilateImageFilterITK::create() const {
    return new MovingHistogramDilateImageFilterITK();
}

template<class T>
void MovingHistogramDilateImageFilterITK::movingHistogramDilateImageFilterITK() {
    ...
    if(structuringElement_.get() == "binaryBall"){
        ...
        typedef itk::MovingHistogramDilateImageFilter<InputImageType1, OutputImageType1, KernelType> FilterType;
...
void MovingHistogramDilateImageFilterITK::process() {
