...
#include "reconstructionbydilationimagefilter.h"
...
const std::string ReconstructionByDilationImageFilterITK::loggerCat_("voreen.ReconstructionByDilationImageFilterITK");

ReconstructionByDilationImageFilterITK::ReconstructionByDilationImageFilterITK()
    : ITKProcessor(),
...
Processor* ReconstructionByDilationImageFilterITK::create() const {
    return new ReconstructionByDilationImageFilterITK();
}

template<class T, class S>
void ReconstructionByDilationImageFilterITK::reconstructionByDilationImageFilterITK() {
    ...
    //Filter define
    typedef itk::ReconstructionByDilationImageFilter<InputImageType1, OutputImageType1> FilterType;
...
void ReconstructionByDilationImageFilterITK::process() {
...
template <class T>
void ReconstructionByDilationImageFilterITK::volumeTypeSwitch1() {
