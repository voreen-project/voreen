...
#include "basicerodeimagefilter.h"
...
const std::string BasicErodeImageFilterITK::loggerCat_("voreen.BasicErodeImageFilterITK");

BasicErodeImageFilterITK::BasicErodeImageFilterITK()
    : ITKProcessor(),
...
Processor* BasicErodeImageFilterITK::create() const {
    return new BasicErodeImageFilterITK();
}

template<class T>
void BasicErodeImageFilterITK::basicErodeImageFilterITK() {
    ...
    if(structuringElement_.get() == "binaryBall"){
        ...
        typedef itk::BasicErodeImageFilter<InputImageType1, OutputImageType1, KernelType> FilterType;
...
void BasicErodeImageFilterITK::process() {
