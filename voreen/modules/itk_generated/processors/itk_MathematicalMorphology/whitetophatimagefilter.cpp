...
#include "whitetophatimagefilter.h"
...
const std::string WhiteTopHatImageFilterITK::loggerCat_("voreen.WhiteTopHatImageFilterITK");

WhiteTopHatImageFilterITK::WhiteTopHatImageFilterITK()
    : ITKProcessor(),
...
Processor* WhiteTopHatImageFilterITK::create() const {
    return new WhiteTopHatImageFilterITK();
}

template<class T>
void WhiteTopHatImageFilterITK::whiteTopHatImageFilterITK() {
    ...
    if(structuringElement_.get() == "binaryBall"){
        ...
        typedef itk::WhiteTopHatImageFilter<InputImageType1, OutputImageType1, KernelType> FilterType;
...
void WhiteTopHatImageFilterITK::process() {
