...
#include "checkerboardimagefilter.h"
...
const std::string CheckerBoardImageFilterITK::loggerCat_("voreen.CheckerBoardImageFilterITK");

CheckerBoardImageFilterITK::CheckerBoardImageFilterITK()
    : ITKProcessor(),
...
Processor* CheckerBoardImageFilterITK::create() const {
    return new CheckerBoardImageFilterITK();
}

template<class T, class S>
void CheckerBoardImageFilterITK::checkerBoardImageFilterITK() {
    ...
    //Filter define
    typedef itk::CheckerBoardImageFilter<InputImageType1> FilterType;
...
void CheckerBoardImageFilterITK::process() {
...
template <class T>
void CheckerBoardImageFilterITK::volumeTypeSwitch1() {
