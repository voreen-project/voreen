...
#include "similarityindeximagefilter.h"
...
const std::string SimilarityIndexImageFilterITK::loggerCat_("voreen.SimilarityIndexImageFilterITK");

SimilarityIndexImageFilterITK::SimilarityIndexImageFilterITK()
    : ITKProcessor(),
    inport1_(Port::INPORT, "InputImage1"),
    inport2_(Port::INPORT, "InputImage2"),
    similarityIndex_("similarityIndex", "SimilarityIndex", 0.f, -FLT_MAX, FLT_MAX)
{
    addPort(inport1_);
    ...
    addProperty(similarityIndex_);
    similarityIndex_.setReadOnlyFlag(true);

}

Processor* SimilarityIndexImageFilterITK::create() const {
    return new SimilarityIndexImageFilterITK();
}
...
void SimilarityIndexImageFilterITK::process() {
...
template <class T>
void SimilarityIndexImageFilterITK::volumeTypeSwitch1() {
