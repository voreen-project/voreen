...
#include "absolutevaluedifferenceimagefilter.h"
...
const std::string AbsoluteValueDifferenceImageFilterITK::loggerCat_("voreen.AbsoluteValueDifferenceImageFilterITK");

AbsoluteValueDifferenceImageFilterITK::AbsoluteValueDifferenceImageFilterITK()
    : ITKProcessor(),
...
Processor* AbsoluteValueDifferenceImageFilterITK::create() const {
    return new AbsoluteValueDifferenceImageFilterITK();
}

template<class T, class S>
void AbsoluteValueDifferenceImageFilterITK::absoluteValueDifferenceImageFilterITK() {
    ...
    //Filter define
    typedef itk::AbsoluteValueDifferenceImageFilter<InputImageType1, InputImageType2, OutputImageType1> FilterType;
...
void AbsoluteValueDifferenceImageFilterITK::process() {
...
template <class T>
void AbsoluteValueDifferenceImageFilterITK::volumeTypeSwitch1() {
