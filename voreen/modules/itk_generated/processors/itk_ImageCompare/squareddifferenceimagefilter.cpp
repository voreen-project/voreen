...
#include "squareddifferenceimagefilter.h"
...
const std::string SquaredDifferenceImageFilterITK::loggerCat_("voreen.SquaredDifferenceImageFilterITK");

SquaredDifferenceImageFilterITK::SquaredDifferenceImageFilterITK()
    : ITKProcessor(),
...
Processor* SquaredDifferenceImageFilterITK::create() const {
    return new SquaredDifferenceImageFilterITK();
}

template<class T, class S>
void SquaredDifferenceImageFilterITK::squaredDifferenceImageFilterITK() {
    ...
    //Filter define
    typedef itk::SquaredDifferenceImageFilter<InputImageType1, InputImageType2, OutputImageType1> FilterType;
...
void SquaredDifferenceImageFilterITK::process() {
...
template <class T>
void SquaredDifferenceImageFilterITK::volumeTypeSwitch1() {
