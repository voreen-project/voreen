...
#include "laplacianrecursivegaussianimagefilter.h"
...
const std::string LaplacianRecursiveGaussianImageFilterITK::loggerCat_("voreen.LaplacianRecursiveGaussianImageFilterITK");

LaplacianRecursiveGaussianImageFilterITK::LaplacianRecursiveGaussianImageFilterITK()
    : ITKProcessor(),
...
Processor* LaplacianRecursiveGaussianImageFilterITK::create() const {
    return new LaplacianRecursiveGaussianImageFilterITK();
}

template<class T>
void LaplacianRecursiveGaussianImageFilterITK::laplacianRecursiveGaussianImageFilterITK() {
    ...
    //Filter define
    typedef itk::LaplacianRecursiveGaussianImageFilter<InputImageType1, OutputImageType1> FilterType;
...
void LaplacianRecursiveGaussianImageFilterITK::process() {
