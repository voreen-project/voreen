...
const std::string SobelEdgeDetectionImageFilterITK::loggerCat_("voreen.SobelEdgeDetectionImageFilterITK");

SobelEdgeDetectionImageFilterITK::SobelEdgeDetectionImageFilterITK()
    : ITKProcessor(),
...
Processor* SobelEdgeDetectionImageFilterITK::create() const {
    return new SobelEdgeDetectionImageFilterITK();
}

template<class T>
void SobelEdgeDetectionImageFilterITK::sobelEdgeDetectionImageFilterITK() {
    ...
    //Filter define
    typedef itk::SobelEdgeDetectionImageFilter<InputImageType1, OutputImageType1> FilterType;
...
void SobelEdgeDetectionImageFilterITK::process() {
