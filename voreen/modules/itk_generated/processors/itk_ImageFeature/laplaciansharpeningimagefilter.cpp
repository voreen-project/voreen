...
#include "laplaciansharpeningimagefilter.h"
...
const std::string LaplacianSharpeningImageFilterITK::loggerCat_("voreen.LaplacianSharpeningImageFilterITK");

LaplacianSharpeningImageFilterITK::LaplacianSharpeningImageFilterITK()
    : ITKProcessor(),
    inport1_(Port::INPORT, "InputImage"),
    outport1_(Port::OUTPORT, "OutputImage"),
    enableProcessing_("enabled", "Enable", false),
    useImageSpacing_("useImageSpacing", "UseImageSpacing", true)
{
    addPort(inport1_);
...
Processor* LaplacianSharpeningImageFilterITK::create() const {
    return new LaplacianSharpeningImageFilterITK();
}
...
void LaplacianSharpeningImageFilterITK::process() {
