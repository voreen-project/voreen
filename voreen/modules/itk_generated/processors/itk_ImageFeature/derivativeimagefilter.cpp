...
#include "derivativeimagefilter.h"
...
const std::string DerivativeImageFilterITK::loggerCat_("voreen.DerivativeImageFilterITK");

DerivativeImageFilterITK::DerivativeImageFilterITK()
    : ITKProcessor(),
    ...
    direction_("direction", "Direction", 0, 0, 2),
    order_("order", "Order", 1, 0, 255)
{
    addPort(inport1_);
...
Processor* DerivativeImageFilterITK::create() const {
    return new DerivativeImageFilterITK();
}

template<class T>
void DerivativeImageFilterITK::derivativeImageFilterITK() {
    ...
    //Filter define
    typedef itk::DerivativeImageFilter<InputImageType1, OutputImageType1> FilterType;
...
void DerivativeImageFilterITK::process() {
