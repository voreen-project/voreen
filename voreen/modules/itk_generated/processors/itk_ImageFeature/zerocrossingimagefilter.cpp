...
#include "zerocrossingimagefilter.h"
...
const std::string ZeroCrossingImageFilterITK::loggerCat_("voreen.ZeroCrossingImageFilterITK");

ZeroCrossingImageFilterITK::ZeroCrossingImageFilterITK()
    : ITKProcessor(),
...
Processor* ZeroCrossingImageFilterITK::create() const {
    return new ZeroCrossingImageFilterITK();
}

template<class T>
void ZeroCrossingImageFilterITK::zeroCrossingImageFilterITK() {
    ...
    //Filter define
    typedef itk::ZeroCrossingImageFilter<InputImageType1, OutputImageType1> FilterType;
...
void ZeroCrossingImageFilterITK::process() {
