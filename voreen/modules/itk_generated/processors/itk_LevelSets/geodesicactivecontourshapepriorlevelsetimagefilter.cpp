...
#include "geodesicactivecontourshapepriorlevelsetimagefilter.h"
...
const std::string GeodesicActiveContourShapePriorLevelSetImageFilterITK::loggerCat_("voreen.GeodesicActiveContourShapePriorLevelSetImageFilterITK");

GeodesicActiveContourShapePriorLevelSetImageFilterITK::GeodesicActiveContourShapePriorLevelSetImageFilterITK()
    : ITKProcessor(),
...
Processor* GeodesicActiveContourShapePriorLevelSetImageFilterITK::create() const {
    return new GeodesicActiveContourShapePriorLevelSetImageFilterITK();
}

template<class T, class S>
void GeodesicActiveContourShapePriorLevelSetImageFilterITK::geodesicActiveContourShapePriorLevelSetImageFilterITK() {
    ...
    //Filter define
    typedef itk::GeodesicActiveContourShapePriorLevelSetImageFilter<InputImageType1, InputImageType2> FilterType;
...
void GeodesicActiveContourShapePriorLevelSetImageFilterITK::process() {
...
template <class T>
void GeodesicActiveContourShapePriorLevelSetImageFilterITK::volumeTypeSwitch1() {
    ...
    if (dynamic_cast<const VolumeRAM_Float*>(inputVolume2))  {
        geodesicActiveContourShapePriorLevelSetImageFilterITK<T, float>();
    }
    else {
