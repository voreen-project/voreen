...
#include "geodesicactivecontourlevelsetimagefilter.h"
...
const std::string GeodesicActiveContourLevelSetImageFilterITK::loggerCat_("voreen.GeodesicActiveContourLevelSetImageFilterITK");

GeodesicActiveContourLevelSetImageFilterITK::GeodesicActiveContourLevelSetImageFilterITK()
    : ITKProcessor(),
...
Processor* GeodesicActiveContourLevelSetImageFilterITK::create() const {
    return new GeodesicActiveContourLevelSetImageFilterITK();
}

template<class T, class S>
void GeodesicActiveContourLevelSetImageFilterITK::geodesicActiveContourLevelSetImageFilterITK() {
    ...
    //Filter define
    typedef itk::GeodesicActiveContourLevelSetImageFilter<InputImageType1, InputImageType2> FilterType;
...
void GeodesicActiveContourLevelSetImageFilterITK::process() {
...
template <class T>
void GeodesicActiveContourLevelSetImageFilterITK::volumeTypeSwitch1() {
    ...
    if (dynamic_cast<const VolumeRAM_Float*>(inputVolume2))  {
        geodesicActiveContourLevelSetImageFilterITK<T, float>();
    }
    else {
