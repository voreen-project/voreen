...
#include "shapedetectionlevelsetimagefilter.h"
...
const std::string ShapeDetectionLevelSetImageFilterITK::loggerCat_("voreen.ShapeDetectionLevelSetImageFilterITK");

ShapeDetectionLevelSetImageFilterITK::ShapeDetectionLevelSetImageFilterITK()
    : ITKProcessor(),
...
Processor* ShapeDetectionLevelSetImageFilterITK::create() const {
    return new ShapeDetectionLevelSetImageFilterITK();
}

template<class T, class S>
void ShapeDetectionLevelSetImageFilterITK::shapeDetectionLevelSetImageFilterITK() {
    ...
    //Filter define
    typedef itk::ShapeDetectionLevelSetImageFilter<InputImageType1, InputImageType2> FilterType;
...
void ShapeDetectionLevelSetImageFilterITK::process() {
...
template <class T>
void ShapeDetectionLevelSetImageFilterITK::volumeTypeSwitch1() {
    ...
    if (dynamic_cast<const VolumeRAM_Float*>(inputVolume2))  {
        shapeDetectionLevelSetImageFilterITK<T, float>();
    }
    else {
