...
#include "curveslevelsetimagefilter.h"
...
const std::string CurvesLevelSetImageFilterITK::loggerCat_("voreen.CurvesLevelSetImageFilterITK");

CurvesLevelSetImageFilterITK::CurvesLevelSetImageFilterITK()
    : ITKProcessor(),
...
Processor* CurvesLevelSetImageFilterITK::create() const {
    return new CurvesLevelSetImageFilterITK();
}

template<class T, class S>
void CurvesLevelSetImageFilterITK::curvesLevelSetImageFilterITK() {
    ...
    //Filter define
    typedef itk::CurvesLevelSetImageFilter<InputImageType1, InputImageType2> FilterType;
...
void CurvesLevelSetImageFilterITK::process() {
...
template <class T>
void CurvesLevelSetImageFilterITK::volumeTypeSwitch1() {
    ...
    if (dynamic_cast<const VolumeRAM_Float*>(inputVolume2))  {
        curvesLevelSetImageFilterITK<T, float>();
    }
    else {
