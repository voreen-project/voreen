...
#include "binarydilateimagefilter.h"
...
const std::string BinaryDilateImageFilterITK::loggerCat_("voreen.BinaryDilateImageFilterITK");

BinaryDilateImageFilterITK::BinaryDilateImageFilterITK()
    : ITKProcessor(),
    inport1_(Port::INPORT, "InputImage"),
    outport1_(Port::OUTPORT, "OutputImage"),
    enableProcessing_("enabled", "Enable", false),
    dilateValue_("dilateValue", "DilateValue"),
    ...
    radius_("Radius", "Radius", tgt::ivec3(1),tgt::ivec3(1),tgt::ivec3(20))
{
    ...
    addProperty(dilateValue_);

}

Processor* BinaryDilateImageFilterITK::create() const {
    return new BinaryDilateImageFilterITK();
}

template<class T>
void BinaryDilateImageFilterITK::binaryDilateImageFilterITK() {
    dilateValue_.setVolume(inport1_.getData());
    ...
    if(structuringElement_.get() == "binaryBall"){
        ...
        typedef itk::BinaryDilateImageFilter<InputImageType1, OutputImageType1, KernelType> FilterType;
        typename FilterType::Pointer filter = FilterType::New();

    filter->SetInput(p1);

    filter->SetDilateValue(dilateValue_.getValue<T>());
...
void BinaryDilateImageFilterITK::process() {
