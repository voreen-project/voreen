...
#include "binarymorphologicalopeningimagefilter.h"
...
const std::string BinaryMorphologicalOpeningImageFilterITK::loggerCat_("voreen.BinaryMorphologicalOpeningImageFilterITK");

BinaryMorphologicalOpeningImageFilterITK::BinaryMorphologicalOpeningImageFilterITK()
    : ITKProcessor(),
...
Processor* BinaryMorphologicalOpeningImageFilterITK::create() const {
    return new BinaryMorphologicalOpeningImageFilterITK();
}

template<class T>
void BinaryMorphologicalOpeningImageFilterITK::binaryMorphologicalOpeningImageFilterITK() {
    ...
    if(structuringElement_.get() == "binaryBall"){
        ...
        typedef itk::BinaryMorphologicalOpeningImageFilter<InputImageType1, OutputImageType1, KernelType> FilterType;
...
void BinaryMorphologicalOpeningImageFilterITK::process() {
