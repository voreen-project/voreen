...
#include "dilateobjectmorphologyimagefilter.h"
...
const std::string DilateObjectMorphologyImageFilterITK::loggerCat_("voreen.DilateObjectMorphologyImageFilterITK");

DilateObjectMorphologyImageFilterITK::DilateObjectMorphologyImageFilterITK()
    : ITKProcessor(),
...
Processor* DilateObjectMorphologyImageFilterITK::create() const {
    return new DilateObjectMorphologyImageFilterITK();
}
...
void DilateObjectMorphologyImageFilterITK::process() {
