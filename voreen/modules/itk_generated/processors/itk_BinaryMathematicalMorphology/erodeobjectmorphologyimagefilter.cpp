...
#include "erodeobjectmorphologyimagefilter.h"
...
const std::string ErodeObjectMorphologyImageFilterITK::loggerCat_("voreen.ErodeObjectMorphologyImageFilterITK");

ErodeObjectMorphologyImageFilterITK::ErodeObjectMorphologyImageFilterITK()
    : ITKProcessor(),
    ...
    erodeValue_("erodeValue", "ErodeValue"),
    ...
    radius_("Radius", "Radius", tgt::ivec3(1),tgt::ivec3(1),tgt::ivec3(20))
{
    ...
    addProperty(erodeValue_);

}

Processor* ErodeObjectMorphologyImageFilterITK::create() const {
    return new ErodeObjectMorphologyImageFilterITK();
}

template<class T>
void ErodeObjectMorphologyImageFilterITK::erodeObjectMorphologyImageFilterITK() {
    backgroundValue_.setVolume(inport1_.getData());
    erodeValue_.setVolume(inport1_.getData());
    ...
    if(structuringElement_.get() == "binaryBall"){
        ...
        typedef itk::ErodeObjectMorphologyImageFilter<InputImageType1, OutputImageType1, KernelType> FilterType;
        typename FilterType::Pointer filter = FilterType::New();

    filter->SetInput(p1);

    filter->SetBackgroundValue(backgroundValue_.getValue<T>());
    filter->SetErodeValue(erodeValue_.getValue<T>());
...
void ErodeObjectMorphologyImageFilterITK::process() {
