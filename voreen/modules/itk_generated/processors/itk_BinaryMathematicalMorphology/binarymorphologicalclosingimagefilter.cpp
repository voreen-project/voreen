...
#include "binarymorphologicalclosingimagefilter.h"
...
const std::string BinaryMorphologicalClosingImageFilterITK::loggerCat_("voreen.BinaryMorphologicalClosingImageFilterITK");

BinaryMorphologicalClosingImageFilterITK::BinaryMorphologicalClosingImageFilterITK()
    : ITKProcessor(),
...
Processor* BinaryMorphologicalClosingImageFilterITK::create() const {
    return new BinaryMorphologicalClosingImageFilterITK();
}

template<class T>
void BinaryMorphologicalClosingImageFilterITK::binaryMorphologicalClosingImageFilterITK() {
    ...
    if(structuringElement_.get() == "binaryBall"){
        ...
        typedef itk::BinaryMorphologicalClosingImageFilter<InputImageType1, OutputImageType1, KernelType> FilterType;
...
void BinaryMorphologicalClosingImageFilterITK::process() {
