...
const std::string CurvatureFlowImageFilterITK::loggerCat_("voreen.CurvatureFlowImageFilterITK");

CurvatureFlowImageFilterITK::CurvatureFlowImageFilterITK()
    : ITKProcessor(),
    inport1_(Port::INPORT, "InputImage"),
    outport1_(Port::OUTPORT, "OutputImage"),
    enableProcessing_("enabled", "Enable", false),
    timeStep_("timeStep", "TimeStep", 1, 0, 1000)
{
    addPort(inport1_);
...
Processor* CurvatureFlowImageFilterITK::create() const {
    return new CurvatureFlowImageFilterITK();
}

template<class T>
void CurvatureFlowImageFilterITK::curvatureFlowImageFilterITK() {
    ...
    //Filter define
    typedef itk::CurvatureFlowImageFilter<InputImageType1, OutputImageType1> FilterType;
...
void CurvatureFlowImageFilterITK::process() {
