    ...
    propagationScaling_("propagationScaling", "PropagationScaling", 2.0f, 0.0f, 100.0f)
{
    ...
    numSeedPoint_.onChange(MemberFunctionCallback<GeodesicActiveContourShapePriorLevelSetImageFilterWorkflowITK>(this, &GeodesicActiveContourShapePriorLevelSetImageFilterWorkflowITK::process));
