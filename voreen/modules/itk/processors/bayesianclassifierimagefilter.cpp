...
#include "bayesianclassifierimagefilter.h"
...
const std::string BayesianClassifierImageFilterITK::loggerCat_("voreen.BayesianClassifierImageFilterITK");

BayesianClassifierImageFilterITK::BayesianClassifierImageFilterITK()
    : ITKProcessor(),
    inport1_(Port::INPORT, "input1"),
    outport1_(Port::OUTPORT, "output1"),
    enableProcessing_("enabled", "Enable", false),
    numberOfClasses_("numberOfClasses", "NumberOfClasses", 1, 1, 1000)
{
    addPort(inport1_);
    ...
    addProperty(numberOfClasses_);

}

Processor* BayesianClassifierImageFilterITK::create() const {
    return new BayesianClassifierImageFilterITK();
}
...
void BayesianClassifierImageFilterITK::process() {
