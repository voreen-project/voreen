...
#include "geodesicactivecontourlevelsetimagefilterworkflow.h"
...
const std::string GeodesicActiveContourLevelSetImageFilterWorkflowITK::loggerCat_("voreen.GeodesicActiveContourLevelSetImageFilterWorkflowITK");

GeodesicActiveContourLevelSetImageFilterWorkflowITK::GeodesicActiveContourLevelSetImageFilterWorkflowITK()
    : ITKProcessor(),
    ...
    propagationScaling_("propagationScaling", "PropagationScaling", 2.0f, 0.0f, 100.0f)
{
    ...
    numSeedPoint_.onChange(MemberFunctionCallback<GeodesicActiveContourLevelSetImageFilterWorkflowITK>(this, &GeodesicActiveContourLevelSetImageFilterWorkflowITK::process));
    ...
    setPropertyGroupGuiName("segmentation", "GeodesicActiveContourLevelSet");
}

Processor* GeodesicActiveContourLevelSetImageFilterWorkflowITK::create() const {
    return new GeodesicActiveContourLevelSetImageFilterWorkflowITK();
}



template<class T>
void GeodesicActiveContourLevelSetImageFilterWorkflowITK::geodesicActiveContourLevelSetImageFilterWorkflowITK() {
    ...
    //LevelsetFilter
    typedef itk::GeodesicActiveContourLevelSetImageFilter<InputImageType, InputImageType> LevelType;
...
void GeodesicActiveContourLevelSetImageFilterWorkflowITK::process() {
    ...
    if (dynamic_cast<const VolumeRAM_Float*>(inputVolume1))  {
        geodesicActiveContourLevelSetImageFilterWorkflowITK<float>();
    }
    else {
