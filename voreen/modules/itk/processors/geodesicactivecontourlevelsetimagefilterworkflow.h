...
#ifndef VRN_GEODESICACTIVECONTOURLEVELSETIMAGEFILTERWORKFLOW_H
...
class GeodesicActiveContourLevelSetImageFilterWorkflowITK : public ITKProcessor {
public:
    GeodesicActiveContourLevelSetImageFilterWorkflowITK();

    virtual Processor* create() const;

    virtual std::string getCategory() const   { return "Volume Processing/Segmentation/LevelSetWorkflows"; }
    virtual std::string getClassName() const  { return "GeodesicActiveContourLevelSetImageFilterWorkflowITK";  }
...
protected:
    ...
    template<class T>
    void geodesicActiveContourLevelSetImageFilterWorkflowITK();
