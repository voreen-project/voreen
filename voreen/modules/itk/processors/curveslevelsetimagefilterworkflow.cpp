...
#include "curveslevelsetimagefilterworkflow.h"
...
const std::string CurvesLevelSetImageFilterWorkflowITK::loggerCat_("voreen.CurvesLevelSetImageFilterWorkflowITK");

CurvesLevelSetImageFilterWorkflowITK::CurvesLevelSetImageFilterWorkflowITK()
    : ITKProcessor(),
    ...
    propagationScaling_("propagationScaling", "PropagationScaling", 2.0f, 0.0f, 100.0f)
{
    ...
    numSeedPoint_.onChange(MemberFunctionCallback<CurvesLevelSetImageFilterWorkflowITK>(this, &CurvesLevelSetImageFilterWorkflowITK::process));
    ...
    //properties for CurvesLevelSet
    addProperty(propagationScaling_);
    propagationScaling_.setGroupID("segmentation");
    setPropertyGroupGuiName("segmentation", "Curves LevelSet");
}

Processor* CurvesLevelSetImageFilterWorkflowITK::create() const {
    return new CurvesLevelSetImageFilterWorkflowITK();
}



template<class T>
void CurvesLevelSetImageFilterWorkflowITK::curvesLevelSetImageFilterWorkflowITK() {
    ...
    //LevelsetFilter
    typedef itk::CurvesLevelSetImageFilter<InputImageType, InputImageType> LevelType;
...
void CurvesLevelSetImageFilterWorkflowITK::process() {
    ...
    if (dynamic_cast<const VolumeRAM_Float*>(inputVolume1))  {
        curvesLevelSetImageFilterWorkflowITK<float>();
    }
    else {
