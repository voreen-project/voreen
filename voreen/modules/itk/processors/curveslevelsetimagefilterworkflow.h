...
#ifndef VRN_CURVESLEVELSETIMAGEFILTERWORKFLOW_H
#define VRN_CURVESLEVELSETIMAGEFILTERWORKFLOW_H
...
class CurvesLevelSetImageFilterWorkflowITK : public ITKProcessor {
public:
    CurvesLevelSetImageFilterWorkflowITK();

    virtual Processor* create() const;

    virtual std::string getCategory() const   { return "Volume Processing/Segmentation/LevelSetWorkflows"; }
    virtual std::string getClassName() const  { return "CurvesLevelSetImageFilterWorkflowITK";  }
...
protected:
    ...
    template<class T>
    void curvesLevelSetImageFilterWorkflowITK();
