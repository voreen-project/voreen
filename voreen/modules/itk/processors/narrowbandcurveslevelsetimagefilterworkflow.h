...
#ifndef VRN_NARROWBANDCURVESLEVELSETIMAGEFILTERWORKFLOW_H
#define VRN_NARROWBANDCURVESLEVELSETIMAGEFILTERWORKFLOW_H
...
class NarrowBandCurvesLevelSetImageFilterWorkflowITK : public ITKProcessor {
public:
    NarrowBandCurvesLevelSetImageFilterWorkflowITK();

    virtual Processor* create() const;

    virtual std::string getCategory() const   { return "Volume Processing/Segmentation/LevelSetWorkflows"; }
    virtual std::string getClassName() const  { return "NarrowBandCurvesLevelSetImageFilterWorkflowITK";  }
...
protected:
    ...
    template<class T>
    void narrowBandCurvesLevelSetImageFilterWorkflowITK();
