...
#include "narrowbandthresholdsegmentationlevelsetimagefilterworkflow.h"
...
const std::string NarrowBandThresholdSegmentationLevelSetImageFilterWorkflowITK::loggerCat_("voreen.NarrowBandThresholdSegmentationLevelSetImageFilterWorkflowITK");

NarrowBandThresholdSegmentationLevelSetImageFilterWorkflowITK::NarrowBandThresholdSegmentationLevelSetImageFilterWorkflowITK()
    : ITKProcessor(),
...

{
    ...
    numSeedPoint_.onChange(MemberFunctionCallback<NarrowBandThresholdSegmentationLevelSetImageFilterWorkflowITK>(this, &NarrowBandThresholdSegmentationLevelSetImageFilterWorkflowITK::process));
    ...
    setPropertyGroupGuiName("segmentation", "NarrowBandThresholdSegmentationLevelSet");
}

Processor* NarrowBandThresholdSegmentationLevelSetImageFilterWorkflowITK::create() const {
    return new NarrowBandThresholdSegmentationLevelSetImageFilterWorkflowITK();
}



template<class T>
void NarrowBandThresholdSegmentationLevelSetImageFilterWorkflowITK::narrowBandThresholdSegmentationLevelSetImageFilterWorkflowITK() {
    ...
    //LevelsetFilter
    typedef itk::NarrowBandThresholdSegmentationLevelSetImageFilter<InputImageType, InputImageType> LevelType;
...
void NarrowBandThresholdSegmentationLevelSetImageFilterWorkflowITK::process() {
    ...
    if (dynamic_cast<const VolumeRAM_Float*>(inputVolume1))  {
        narrowBandThresholdSegmentationLevelSetImageFilterWorkflowITK<float>();
    }
    else {
