...
#ifndef VRN_GEODESICACTIVECONTOUSHAPEPRIORRLEVELSETIMAGEFILTERWORKFLOW_H
#define VRN_GEODESICACTIVECONTOURLEVELSETIMAGEFILTERWORKFLOW_H
...
class GeodesicActiveContourShapePriorLevelSetImageFilterWorkflowITK : public ITKProcessor {
public:
    GeodesicActiveContourShapePriorLevelSetImageFilterWorkflowITK();

    virtual Processor* create() const;

    virtual std::string getCategory() const   { return "Volume Processing/Segmentation/LevelSetWorkflows"; }
    virtual std::string getClassName() const  { return "GeodesicActiveContourShapePriorLevelSetImageFilterWorkflowITK";  }
...
protected:
    ...
    template<class T>
    void geodesicActiveContourShapePriorLevelSetImageFilterWorkflowITK();
