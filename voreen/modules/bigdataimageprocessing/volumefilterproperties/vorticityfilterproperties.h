...
#ifndef VRN_VORTICITYFILTERPROPERTIES_H
#define VRN_VORTICITYFILTERPROPERTIES_H
...
class VorticityFilterProperties : public FilterProperties {
public:
    VorticityFilterProperties();
