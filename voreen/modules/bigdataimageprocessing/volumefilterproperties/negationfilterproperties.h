...
#ifndef VRN_NEGATIONFILTERPROPERTIES_H
#define VRN_NEGATIONFILTERPROPERTIES_H
...
class NegationFilterProperties : public FilterProperties {
public:
    NegationFilterProperties();
...
private:
    ...
    BoolProperty negateX_;
    BoolProperty negateY_;
    BoolProperty negateZ_;
    BoolProperty negateW_;
};
