...
#ifndef VRN_POIPOINTSEGMENTGEOMETRYIMPORTER
#define VRN_POIPOINTSEGMENTGEOMETRYIMPORTER
 ...
 */
class VRN_CORE_API POIPointSegmentImporter : public Processor {
public:
    POIPointSegmentImporter();
