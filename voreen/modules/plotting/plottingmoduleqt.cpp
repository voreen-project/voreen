...
#include "plottingmoduleqt.h"

#include "qt/processorwidgets/plotprocessorwidgetfactory.h"
#include "qt/propertywidgets/plotpropertywidgetfactory.h"

namespace voreen {

const std::string PlottingModuleQt::loggerCat_("voreen.plotting.PlottingModuleQt");
