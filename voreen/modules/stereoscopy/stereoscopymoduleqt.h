...
#ifndef VRN_STEREOSCOPYMODULE_QT_H
#define VRN_STEREOSCOPYMODULE_QT_H
 ...
 */
class StereoscopyModuleQt : public VoreenModuleQt {

public:
    StereoscopyModuleQt(const std::string& modulePath);
...
#endif // VRN_STEREOSCOPYMODULE_QT_H
