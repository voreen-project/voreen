...
namespace voreen{
VoreenVeStartupWizard::VoreenVeStartupWizard(QStringList recentWorkspaceNames, QStringList standardWorkspaceNames,
...
QLabel* VoreenVeStartupWizard::getLogoLabel(){
    QPixmap logoPixmap(":/voreenve/image/logo-startup-wizard.png");
