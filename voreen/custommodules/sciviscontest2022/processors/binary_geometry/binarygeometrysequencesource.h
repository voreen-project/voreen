...
#ifndef VRN_BINARYGEOMETRYSEQUENCESOURCE_H
#define VRN_BINARYGEOMETRYSEQUENCESOURCE_H
...
/**
 * Reads a Voreen Binary Geometry Sequence from a file
 * and provides it as geometry through its outport.
 */
class VRN_CORE_API BinaryGeometrySequenceSource : public Processor {
public:
	BinaryGeometrySequenceSource();
    Processor* create() const override;

    std::string getClassName() const override { return "BinaryGeometrySequenceSource";   }
...
protected:
    void setDescriptions() override {
        setDescription("Loads a serialized Voreen Binary Geometry (.vbge) from across multiple files.");
    }
...
private:
    ...
    FileDialogProperty geometryDirectory_;
...
#endif // VRN_BINARYGEOMETRYSEQUENCESOURCE_H
