...
#include "seededstreamlinecreator.h"
...
const std::string SeededStreamlineCreator::loggerCat_{ "flowanalysis.SeededStreamlineCreator" };

SeededStreamlineCreator::SeededStreamlineCreator() :
    StreamlineCreator(),
...
bool SeededStreamlineCreator::isReady() const {
    return StreamlineCreator::isReady() && seedingCurveInport_.hasData();
}

StreamlineCreatorInput SeededStreamlineCreator::prepareComputeInput() {
    auto result = StreamlineCreator::prepareComputeInput();
