...
#ifndef VRN_CONCRETEVESSELGRAPHPORT_H
#define VRN_CONCRETEVESSELGRAPHPORT_H
...
namespace voreen {
    ...
    class ConcreteVesselGraphPort : public GenericPort<ConcreteVesselGraph> {
    public:
        ConcreteVesselGraphPort(PortDirection direction, const std::string& name, const std::string& guiName = "",
        ...
        virtual std::string getClassName() const { return "ConcreteVesselGraphPort"; }
