...
#ifndef VRN_TEMPLATEVESSELGRAPHPORT_H
#define VRN_TEMPLATEVESSELGRAPHPORT_H
...
namespace voreen {
    ...
    class TemplateVesselGraphPort : public GenericPort<TemplateVesselGraph> {
    public:
        TemplateVesselGraphPort(PortDirection direction, const std::string& name, const std::string& guiName = "",
        ...
        virtual std::string getClassName() const { return "TemplateVesselGraphPort"; }
