...
#ifndef VRN_PATCHCAFFECLASSIFIER_H
#define VRN_PATCHCAFFECLASSIFIER_H
...
class VRN_CORE_API PatchCaffeClassifier : public PatchFeatureExtractor {
public:
    PatchCaffeClassifier();

    virtual Processor* create() const;

    virtual std::string getClassName() const  { return "PatchCaffeClassifier";      }
...
protected:
    virtual void setDescriptions() {
        setDescription("Classifies Stuff.");
    }
