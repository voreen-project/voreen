...
#ifndef VRN_FIELDPLOTDATAPORT_H
#define VRN_FIELDPLOTDATAPORT_H
 ...
 * @see FieldPlotData
 */
class FieldPlotDataPort : public GenericPort<FieldPlotData> {
public:
    FieldPlotDataPort(PortDirection direction, const std::string& id, const std::string& guiName = "",
