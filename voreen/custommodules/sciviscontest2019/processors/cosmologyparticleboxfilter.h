...
#ifndef VRN_COSMOLOGYPARTICLEBOXFILTER_H
#define VRN_COSMOLOGYPARTICLEBOXFILTER_H
...
class VRN_CORE_API CosmologyParticleBoxFilter : public Processor {

public:
    CosmologyParticleBoxFilter();

    virtual Processor*  create() const       { return new CosmologyParticleBoxFilter(); }
    virtual std::string getClassName() const { return "CosmologyParticleBoxFilter";     }
...
private:
    ...
    FloatBoundingBoxProperty boundingBox_;
