...
IF(YAML_CPP_INCLUDE_DIR) # Apparently YAML_CPP does not declare a *_FOUND
    ...
    IF(VRN_MSVC)
        ...
        FOREACH(elem ${YAML_CPP_LIBRARIES})
            ...
            #LIST(APPEND MOD_RELEASE_DLLS ${YAML-CPP_DIR}/../bin/${YAML_CPP_LIBRARIES}.dll)
            #LIST(APPEND MOD_RELEASE_LIBRARIES ${YAML-CPP_DIR}/../lib/${YAML_CPP_LIBRARIES}.lib)
            LIST(APPEND MOD_DEBUG_DLLS ${YAML-CPP_DIR}/../bin/${YAML_CPP_LIBRARIES}.dll)
            LIST(APPEND MOD_DEBUG_LIBRARIES ${YAML-CPP_DIR}/../lib/${YAML_CPP_LIBRARIES}.lib)
        ENDFOREACH()
    ELSE()
