...
const std::string LymphaticTestVesselGenerator::loggerCat_("voreen.vesseltopology.lymphatictestvesselgenerator");
...
LymphaticTestVesselGenerator::LymphaticTestVesselGenerator()
    ...
    , spacing_("spacing", "Spacing", tgt::ivec3(1), tgt::ivec3(0.01), tgt::ivec3(100))
