...
/**
 * This is the spherical raycaster. It allows to generate three output
 ...
 */
class VRN_CORE_API SphericalRaycaster : public VolumeRaycaster {
public:
    SphericalRaycaster();
    virtual Processor* create() const;

    virtual std::string getClassName() const    { return "SphericalRaycaster"; }
...
protected:
    virtual void setDescriptions() {
        setDescription("This is the Spherical Raycaster for Scivis 2021\
...
#endif // VRN_SPHERICALRAYCASTER_H
