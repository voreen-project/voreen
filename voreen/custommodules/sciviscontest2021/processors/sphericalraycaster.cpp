...
const std::string SphericalRaycaster::loggerCat_("voreen.SphericalRaycaster");

    SphericalRaycaster::SphericalRaycaster()
    ...
    , shaderProp_("raycast.prg", "Spherical Raycasting Shader", "rc_sphericalvolume.frag", "passthrough.vert", "", Processor::INVALID_PROGRAM, Property::LOD_ADVANCED)
    , camera_("camera", "Camera", tgt::Camera(vec3(0.f, 0.f, 3.5f), vec3(0.f, 0.f, 0.f), vec3(0.f, 1.f, 0.f)), true)
    , radiusMin_("radiusMin", "Set Radius Min", 3485.0f, 3485.0f, 6371.0f)
    , radiusMax_("radiusMax", "Set Radius Max", 6371.0f, 3485.0f, 6371.0f)
    , shiftFactor_("shiftFactor", "Set shift factor", 100.0f, 0.0f, 1000.0f)

{

    volumeInport_.onChange(MemberFunctionCallback<SphericalRaycaster>(this, &SphericalRaycaster::volumeInportOnChange));
    ...
    classificationMode_.onChange(MemberFunctionCallback<SphericalRaycaster>(this, &SphericalRaycaster::adjustPropertyVisibilities));
    shadeMode_.onChange(MemberFunctionCallback<SphericalRaycaster>(this, &SphericalRaycaster::adjustPropertyVisibilities));
    compositingMode1_.onChange(MemberFunctionCallback<SphericalRaycaster>(this, &SphericalRaycaster::adjustPropertyVisibilities));
    compositingMode2_.onChange(MemberFunctionCallback<SphericalRaycaster>(this, &SphericalRaycaster::adjustPropertyVisibilities));
    compositingMode3_.onChange(MemberFunctionCallback<SphericalRaycaster>(this, &SphericalRaycaster::adjustPropertyVisibilities));
    applyLightAttenuation_.onChange(MemberFunctionCallback<SphericalRaycaster>(this, &SphericalRaycaster::adjustPropertyVisibilities));
    transFuncTypeProp_.onChange(MemberFunctionCallback<SphericalRaycaster>(this, &SphericalRaycaster::adjustPropertyVisibilities));
    enableChannelShift_.onChange(MemberFunctionCallback<SphericalRaycaster>(this, &SphericalRaycaster::adjustPropertyVisibilities));
    volumeInport_.onNewData(MemberFunctionCallback<SphericalRaycaster>(this, &SphericalRaycaster::adjustPropertyVisibilities));
}

Processor* SphericalRaycaster::create() const {
    return new SphericalRaycaster();
}

void SphericalRaycaster::initialize() {
...
void SphericalRaycaster::deinitialize() {
    VolumeRaycaster::deinitialize();
}

void SphericalRaycaster::compile() {
    shaderProp_.setHeader(generateHeader());
    shaderProp_.rebuild();
}

bool SphericalRaycaster::isReady() const {
...
void SphericalRaycaster::beforeProcess() {
...
void SphericalRaycaster::process() {
    ...
    //pass radius uniforms to shader
    raycastPrg->setUniform("radiusMin_", radiusMin_.get());
    raycastPrg->setUniform("radiusMax_", radiusMax_.get());
    raycastPrg->setUniform("shiftFactor_", shiftFactor_.get());
...
std::string SphericalRaycaster::generateHeader(const tgt::GpuCapabilities::GlVersion* version) {
...
//      Callbacks
//---------------------------------------------------------------------
void SphericalRaycaster::adjustPropertyVisibilities() {
...
void SphericalRaycaster::volumeInportOnChange() {
