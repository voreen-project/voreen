...
#ifndef VRN_SPHERICALVOLUMEPROXY_H
#define VRN_SPHERICALVOLUMEPROXY_H
 ...
 */
class VRN_CORE_API SphericalVolumeProxy : public Processor,
                                          public PortObserver,
                                          public DataInvalidationObserver {
public:
    SphericalVolumeProxy();
    virtual ~SphericalVolumeProxy();

    virtual Processor* create() const;

    virtual std::string getClassName() const { return "SphericalVolumeProxy"; }
...
#endif // VRN_SPHERICALVOLUMEPROXY_H
