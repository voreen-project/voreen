...
#ifndef VRN_SPHERICALVOLUMERAMPROXY_H
#define VRN_SPHERICALVOLUMERAMPROXY_H
...
class VRN_CORE_API SphericalVolumeRAMProxy : public VolumeRAM {
public:
    ...
    SphericalVolumeRAMProxy(size_t resolution,
...
protected:
    ...
    bool convCCtoSC(tgt::svec3& pos) const;
    float getVoxel(tgt::svec3 pos, size_t channel) const;
    ...
    float minClampRadius_, maxClampRadius_;
