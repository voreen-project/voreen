...
#ifndef VRN_FLOWSIMULATIONCONFIGPORT_H
#define VRN_FLOWSIMULATIONCONFIGPORT_H

#include "voreen/core/ports/genericport.h"

#include "../datastructures/flowsimulationconfig.h"
 ...
 */
class FlowSimulationConfigPort : public GenericPort<FlowSimulationConfig> {
public:
    FlowSimulationConfigPort(PortDirection direction, const std::string& id, const std::string& guiName = "",
