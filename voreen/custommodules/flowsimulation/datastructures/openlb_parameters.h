...
#ifndef VRN_OPENLP_PARAMETERS_H
#define VRN_OPENLP_PARAMETERS_H
...
struct FlowIndicator {
    ...
    float               center_[3];    ///< Center position of the circle shaped area in world space.
    float               normal_[3];    ///< (Normalized) Normal vector defining the orientation.
 ...
 */
class FlowParameterSetEnsemble {
