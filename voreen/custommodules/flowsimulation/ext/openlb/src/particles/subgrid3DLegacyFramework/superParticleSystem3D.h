...
public:
  ...
  /// Add a number of nonidentical particles with normally distributed radius (Box-Muller Method) in a given IndicatorF3D
  ...
  /// Agglomerate detection functions: Todo: enable for parallel mode
  ...
  /// Initialization to be done for t=0: globalPSum = 0, pSumOutlet = 0, diffEscapeRate = 0, maxDiffEscapeRate = 0
