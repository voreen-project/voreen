...
#ifndef SET_ZOUHE_VELOCITY_BOUNDARY_2D_H
#define SET_ZOUHE_VELOCITY_BOUNDARY_2D_H
...
//ZouHe Boundaries use mostly the BGKdynamics collision operator --> MixinDynamics = BGKdynamics<T,DESCRIPTOR>
