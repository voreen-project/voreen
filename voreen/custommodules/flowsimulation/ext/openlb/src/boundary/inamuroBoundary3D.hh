...
Momenta<T,Lattice>*
InamuroBoundaryManager3D<T,Lattice,MixinDynamics>::getVelocityBoundaryMomenta()
{
...
template<typename T, template<typename U> class Lattice, class MixinDynamics>
template<int direction, int orientation>
Dynamics<T,Lattice>* InamuroBoundaryManager3D<T,Lattice,MixinDynamics>::
getVelocityBoundaryDynamics(T omega, Momenta<T,Lattice>& momenta)
{
  return new InamuroNewtonRaphsonDynamics<T,Lattice, MixinDynamics, direction, orientation>(omega, momenta);
}
...
template<int direction, int orientation>
Momenta<T,Lattice>*
InamuroBoundaryManager3D<T,Lattice,MixinDynamics>::getPressureBoundaryMomenta()
{
...
Momenta<T,Lattice>*
InamuroBoundaryManager3D<T,Lattice,MixinDynamics>::getExternalVelocityEdgeMomenta()
{
...
template<int plane, int normal1, int normal2>
Momenta<T,Lattice>*
InamuroBoundaryManager3D<T,Lattice,MixinDynamics>::getInternalVelocityEdgeMomenta()
{
...
Momenta<T,Lattice>*
InamuroBoundaryManager3D<T,Lattice,MixinDynamics>::getExternalVelocityCornerMomenta()
{
  return new FixedVelocityBM<T,Lattice>;
}
...
template<int xNormal, int yNormal, int zNormal>
Momenta<T,Lattice>*
InamuroBoundaryManager3D<T,Lattice,MixinDynamics>::getInternalVelocityCornerMomenta()
{
...
OnLatticeBoundaryCondition3D<T,Lattice>* createInamuroBoundaryCondition3D(BlockLatticeStructure3D<T,Lattice>& block)
{
