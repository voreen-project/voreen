                 ...
                 Timer<double>& timer )
{
  ...
  SuperLatticePhysExternal3D<T, ADDESCRIPTOR> extField(sLatticeAD,
      ...
      ADDESCRIPTOR<T>::ExternalField::velocityBeginsAt,
      ADDESCRIPTOR<T>::ExternalField::sizeOfVelocity);
...
int main( int argc, char* argv[] )
{
  ...
  SuperExternal3D<T, ADDESCRIPTOR> sExternal( superGeometry, sLatticeAD,
      ADDESCRIPTOR<T>::ExternalField::velocityBeginsAt,
      ADDESCRIPTOR<T>::ExternalField::numScalars, sLatticeAD.getOverlap() );
