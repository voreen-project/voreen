...
#ifndef VRN_PROCESSORLISTMENUENTITY_H
#define VRN_PROCESSORLISTMENUENTITY_H
 ...
 */
class ProcessorListMenuEntity : public VoreenQtMenuEntity {

    friend class VoreenQtMainWindow;

public:
    ProcessorListMenuEntity();
    virtual ~ProcessorListMenuEntity();
    virtual QIcon getIcon() const {return QIcon(":/qt/icons/processors.png");}
    virtual std::string getName() const {return "Processors";}
    virtual std::string getShortCut() const {return "";}
    virtual MenuCategory getMenuCategory() const {return MC_BASIC_SIDEBAR;}
    virtual Qt::DockWidgetAreas getAllowedDockWidgetAreas() const {return Qt::LeftDockWidgetArea;}
...
private:
    mutable ProcessorListWidget* processorListWidget_;
};
