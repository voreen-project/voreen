...
#ifndef VRN_TRANSFUNC1DPROPERTY_H
#define VRN_TRANSFUNC1DPROPERTY_H
 ...
 */
class VRN_CORE_API TransFunc1DProperty : public TransFuncPropertyBase {
public:
     ...
     */
    TransFunc1DProperty(const std::string& ident, const std::string& guiText, int invalidationLevel = Processor::INVALID_RESULT,
                          Property::LevelOfDetail lod = Property::LOD_DEFAULT);
    TransFunc1DProperty();
    virtual ~TransFunc1DProperty();
     ...
     */
    void set1D(TransFunc1D* tf);

    /**
     * Returns the current transfer function.
     */
    virtual TransFunc1D* get() const;

    //-------------------------------------------------
    //  Member
    //-------------------------------------------------
protected:
    TransFunc1D* transFunc1D_;  ///< pointer to the current function.
...
#endif // VRN_TRANSFUNC1DPROPERTY_H
