...
InputMappingMenuEntity::InputMappingMenuEntity()
    : VoreenQtMenuEntity()
{}
...
QWidget* InputMappingMenuEntity::createWidget() const {
    dialog_ = new InputMappingDialog(mainWindow_);
    dialog_->resize(520,400);
    WsHndlr.registerWorkspaceUsingWidget(dialog_);
    return dialog_;
}

void InputMappingMenuEntity::deinitialize() {
    if(dialog_)
