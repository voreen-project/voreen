...
void TransFunc2DPrimitivesPropertyEditorCanvas::drawAxes(QPainter* painter) {
    ...
    painter->drawText(static_cast<int>(width() - painter->fontMetrics().horizontalAdvance(X_AXIS_TEXT) - 2.78f * AXIS_OFFSET), static_cast<int>(-1 * (origin.y+1.f - 0.8f * AXIS_OFFSET)), X_AXIS_TEXT);
